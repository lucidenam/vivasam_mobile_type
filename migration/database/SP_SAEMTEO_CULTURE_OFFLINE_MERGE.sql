...
/****** Object:  StoredProcedure [dbo].[SP_SAEMTEO_CULTURE_OFFLINE_MERGE]    Script Date: 2019-01-08 오전 9:01:10 ******/
SET ANSI_NULLS ON
GO
...
BEGIN
	...
	BEGIN TRY;
		...
		WITH TEMP_CULTURE_ACT_INFO (CULTURE_ACT_ID,TITLE,ACT_START_DT,ACT_END_DT,
									CONTENTS,POSTSCRIPT,DATA_STATE_CD,ADM_ID,PROGRAM_GUBUN_CD, TARGET_PLATFORM, MOBILE_CONTENTS, MOBILE_THUM_PATH_URL, MODE) AS (
			SELECT
				@P_CULTURE_ACT_ID,
				@P_TITLE,
				@P_ACT_START_DT,
		...
		USING (
			SELECT 
				...
				T.DATA_STATE_CD,T.ADM_ID, T.PROGRAM_GUBUN_CD, T.TARGET_PLATFORM, T.MOBILE_CONTENTS, T.MOBILE_THUM_PATH_URL, T.MODE 
