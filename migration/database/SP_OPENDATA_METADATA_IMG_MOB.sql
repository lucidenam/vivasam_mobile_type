CREATE PROCEDURE [dbo].[SP_OPENDATA_METADATA_IMG_MOB]
  @pageno	int = 1
  ,@pagesize	int = 20
  ,@ctype	varchar(10) = ''
  ,@code1	varchar(50) = ''
...
BEGIN
  ...
  -- SP_OPENDATA_METADATA 2,20,'img','261005','262051','석탄'
  declare @totalcnt int
  /*
  CALL DBO.SP_OPENDATA_METADATA (? ,? ,? ,? ,? ,? ) }
  17:36:15,679 DEBUG [java.sql.PreparedStatement][Log4jImpl][debug] ==> Parameters: 1(String), 20(String), img(String), 261005(String), 262051(String), 사진(String)
  */
  if @code1 = '' and @code2 = '' and @code3 = '' begin
    ...
    WHERE b.TYPE_1 != '' and b.TYPE_2 != '' and LEFT(b.TYPE_1,3) = '304' and  a.USE_YN = 'Y' and FILE_TYPE = 'FT203'
    ...
    select a.CONTENT_ID,a.CONTENT_GUBUN,b.EDUCOURSE_ID from MASTER_CONTENT AS A
                                                              JOIN MASTER_CONTENT_EDUCOURSE as b
                                                                   on a.CONTENT_ID =  b.CONTENT_ID and a.CONTENT_GUBUN = b.CONTENT_GUBUN
                                                            --WHERE b.TYPE_1 like '261%'  AND  a.USE_YN = 'Y'
    WHERE b.TYPE_1 =@code1  and b.TYPE_2 =@code2 AND  a.USE_YN = 'Y' and FILE_TYPE = 'FT203'
    order by REG_DTTM DESC
    ...
    WHERE CONTAINS (searchtext, @code3) and c.USE_YN = 'Y'
      and FILE_TYPE = 'FT203'
    --and ( b.TYPE_1 like '261%' or TYPE_1 = '1110005' )

    --and b.TYPE_1 = @code1 and b.TYPE_2 = @code2
