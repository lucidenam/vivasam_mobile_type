...
import SnsPersonalIdentification from './SnsPersonalIdentification';
...
class JoinVerification extends Component {
	...
	update(uuid) {
		this.props.history.push({
			pathname: '/sns/join/verifyResult',
			search: '?uuid=' + uuid
		});
	}
	...
	render() {
		let container = <SnsPersonalIdentification callback={this.update} isJoin={true}/>;
