...
class Event extends Component{
    ...
    render () {
        return (
            <section className="event210322">
                <div className="evtCont01">
                    <h1><img src="/images/events/2021/event210322/img01.jpg" alt="비바샘과 함께 만들어가는 꿈꾸는 학교. 2021 비바샘 꿈지기 캠페인" /></h1>
                    <div className="blind">
                        <p>학생들의 꿈을 응원하는 선생님과 함께, 비바샘이 ‘단 하나의 꿈 명함’에 아이들의 예쁜 꿈을 담아 드립니다.<br /><strong>우리 반, 우리 동아리 학생들에게 꿈 명함을 선물하고 싶은 사연을 남겨 주세요!</strong></p>
                    </div>
                </div>

                <div className="evtCont02">
                    <h2><img src="/images/events/2021/event210322/img02.jpg" alt="꿈지기 캠페인 안내" /></h2>
                    <div className="blind">
                        <dl>
                            <dt>캠페인 기간</dt>
                            <dd>1학기: 2021.3.22(월) ~ 6.11(금)<br />2학기: 2021.8.16(월) ~ 11.5(금)</dd>
                            <dt>당첨자 발표</dt>
                            <dd>2주에 1번, 각 10분의 꿈지기 선생님을 선정합니다.<br />- 1학기: 4.6(화) / 4.20(화) / 5.4(화) / 5.18(화) / 6.1(화) / 6.15(화)<br />-2학기: 8.31(화) / 9.14(화) / 9.28(화) / 10.12(화) / 10.26(화) / 11.9일(화)</dd>
                            <dt>캠페인 선물</dt>
                            <dd>학생 1인당 1통의 꿈 명함과 선생님 꿈 명함과 토퍼, 후기 선물을 드립니다.</dd>
                            <dt>꿈 명함 제작 일정</dt>
                            <dd>
                ...
                <div className="evtCont03">
                    <h2><img src="/images/events/2021/event210322/img03.jpg" alt="꼭 참고하세요!" /></h2>
                    <div className="blind">
                        <ul>
                            <li>학급, 동아리 등 50명 이내 그룹 단위로만 신청 가능합니다.</li>
                            <li>구체적인 꿈 명함 활용 계획을 알려주시면 당첨 확률이 올라갑니다.</li>
                            <li>당첨되신 분께 꿈 명함 제작을 위한 정보를 요청 드립니다.</li>
                            <li>꿈지기 생생 후기 게시판에 후기 사진 게재를 위해 학생들의 초상권 활용 동의서를 수급합니다.</li>
                            <li>꿈 명함 수령 후 후기사진을 꼭 보내주세요!</li>
                        </ul>
                    </div>
                    <div className="btnWrap">
                        <a href="https://www.vivasam.com/event/dreamMate/dream2021Part.do?deviceMode=pc" className="btnReview" target={'blank'}><img src="/images/events/2021/event210322/btn_review.png" alt="꿈지기 생생한 후기" /></a>
                        <button type="button" className="btnApply"  onClick={ this.eventApply }><img src="/images/events/2021/event210322/btn_apply.png" alt="캠페인 참여하기" /></button>
                    </div>
                </div>


                <div className="evtCont04" style={{ display : this.state.eventAnswerCount !== 0 ? 'block' : 'none' }}>
                    <h2><img src="/images/events/2021/event210322/img04.jpg" alt="꿈 명함 신청 사연" /></h2>
...
class EventListApply extends Component{
    ...
    eventListApply = () => { // 이벤트 표시 값 세팅
        ...
        eventSetContents = eventSetContents.replace(/\\n/gi, '<br/>');
        let eventSetContents2 = eventSetContents.split('|^|')[12];
