...
class EventApply extends Component {
    ...
    validateInfo = () => {
        ...
        }else if(this.state.infoCheck02 === false){ // 활용 동의 미입력
            obj.message = '캠페인 후기 활용 동의를 확인해 주세요.';
        }else if(!event.agree){
            ...
            <section className="vivasamter">
                ...
                <div className="vivasamter_apply">
                    <div className="vivasamter_applyDtl">
                        ...
                        <p className="mt10 mb25 c_gray">※ 한 그룹 단위로만 신청 가능합니다.</p>
                        <h2 className="info_tit">
                        ...
                        <p className="mt10 mb25 c_gray">※ 인원 수를 정확하게 적어주세요. 50명까지 기입 가능합니다.</p>
                        ...
                        <h2 className="info_tit txt_ls mt25">
                            <label htmlFor="applyContent">꿈 명함을 제작하고픈 특별한 사연이나 아이들의 꿈을 찾아주는 이색적인 활동을 남겨주세요.</label>
                        </h2>
                        <div className="input_wrap">
                            <textarea
                                name="applyContent"
                        ...
                        <div className="linebox mb25">
                            ...
                            <div className="acco_notice_list mt25">
                                ...
                                <div className="acco_notice_cont mt10">
                                    <ul className="policy">
                                        <li>&middot; 학급, 동아리 등 <span>50명 이내 그룹 단위</span>로만 신청 가능합니다.</li>
                                        <li>&middot; 당첨되신 분께 꿈 명함 제작을 위한 정보를 요청드립니다.</li>
                                        <li>&middot; 꿈 명함을 수령 후 반드시 <span>후기 사진</span>을 보내주세요.</li>
                                        <li>&middot; 꿈지기 생생후기 게시판에 후기 사진 게재를 위하여 <span>학생들의 초상권 동의서</span>를 수급합니다.</li>
                                        <li>&middot; 꿈지기 선생님을 한 자리에서 만나는 ‘꿈지기 모꼬지’ 오프라인 행사가 마련될 예정이며, <br/>추후 별도로 안내할 예정입니다.</li>
                                        <li>&middot; 꿈 명함은 <span>재직학교로 배송</span>됩니다. <a href="/#/myInfo">개인정보
                                            확인</a></li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div className="checkbox_circle_box mt10">
                                ...
                                <label
                                    ...
                                    <strong className="checkbox_circle_tit c_gray">본인은 꿈지기 캠페인 참여 유의사항 6가지를 확인하였습니다.</strong>
                                </label>
                            </div>
                            ...
                            <div className="checkbox_circle_box mt10">
                                <input
                                    type="checkbox"
                                    name="evtAgree02"
                                    onChange={this.setInfoCheck02}
                                    checked={this.state.infoCheck02 === true}
                                    className="checkbox_circle checkbox_circle_rel"
                                    id="evtAgree02" />
                                <label
                                    htmlFor="evtAgree02"
                                    className="checkbox_circle_simple">
                                    <strong className="checkbox_circle_tit c_gray">
                                        꿈지기 캠페인 당첨 시, 후기 사진을 제출하고 이를 비바샘 사이트에 탑재하는 것에 동의합니다. <em className="txt_point">(제출하신 사진은 후기 게시판 외 다른 곳에 사용하지 않습니다)</em>
                                    </strong>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="acco_notice_list">
                            ...
                            <div className="acco_notice_cont mt10">
                                <ul className="policy">
                                    ...
                                    <li>- 개인정보 보유 및 이용기간 : 2020년 12월 31일까지 (이용목적 달성 시 즉시 파기)</li>
                                    <li>- 선물 발송을 위해 개인정보(성명/주소/연락처)가 배송업체에 제공됩니다.<br/>
                                    ㈜다우기술-사업자번호: 220-81-02810, ㈜한진-사업자등록번호 : 201-81-02823</li>
                        ...
                        <button
                            ...
                            className="btn_full_on mt35">등록하기</button>
                    </div>
                </div>
            </section>
