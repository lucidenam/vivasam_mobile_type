			...
			<section className="vivasamter event220404">
				...
				<div className="applyDtl_top bg_blue">
					<div className="applyDtl_cell ta_c pick">
						<h3><strong>비상.한.숨 이벤트</strong> 신청하기</h3>
					</div>
				</div>
						...
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList">
									...
									<li>개인정보 보유 및 이용기간 : 2022년 6월 30일까지<br/>(이용목적 달성 시 즉시 파기)</li>
									<li>연락처 오류 시 경품 재발송이 불가능합니다.<br/>개인정보를 꼭 확인해 주세요.</li>
									<li>선물 발송을 위해 서비스/배송 업체에 개인정보(성명, 학교주소, 휴대전화번호)가 제공됩니다.<br/>
										((주)모바일이앤엠애드 사업자등록번호 215-87-19169) ((주)한진 사업자등록번호 201-81-02823) ((주)대한통운 사업자등록번호 110-81-05034)</li>
								</ul>
								<br />
