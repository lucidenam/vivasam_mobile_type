...
class EventApply extends Component {
	...
	validateInfo = () => {
		...
		if (!event.schName) {
			...
			obj.message = '휴대전화번호를 입력해 주세요.';
		} else if (eventAnswer.eventId == 487 && event.receive === "") {
			obj.message = '수령처를 선택해주세요.';
		} else if (eventAnswer.eventId == 487 && event.receive === "교실" && (event.receiveGrade === "" || event.receiveClass === "")) {
			obj.message = '학년 반을 입력해주세요.';
		} else if (eventAnswer.eventId == 487 && event.receive === "기타" && event.receiveEtc === "") {
					...
					eventAnswer.eventId === 487
						...
						<Fragment>
							...
							<div className="applyDtl_top">
								<div className="applyDtl_cell ta_c pick">
									<h3>
										<strong>EVENT 02  - </strong> 동료 선생님 추천 이벤트
									</h3>
								</div>
							</div>
									...
									<div className="acco_notice_list pdside20 mt0">
										<div className="acco_notice_cont">
											...
											<ul className="privacyList type02 ">
												...
												<li>수집하는 개인 정보 : 성명, 재직 학교, 휴대전화번호, 주소(학교, 자택)</li>
												<li>개인정보 보유 및 이용 기간 : 2024년 4월 30일까지 <br/>(이용목적 달성 시 즉시 파기)</li>
												<li>개인정보 오기재로 인한 경품 재발송은 불가능합니다. <br/>개인정보를 꼭 확인해 주세요.</li>
												<li>경품 발송을 위한 개인정보(성함, 휴대 전화번호, 주소)가 배송업체 및 기프티콘 발송 서비스사에 제공됩니다. <br/>(㈜카카오 사업자등록번호 : 120-81-47521)/(㈜다우기술 사업자등록번호: 220-81-02810)/ <br/>(㈜모바일이앤엠애드 사업자등록번호:215-87-19169/(㈜CJ대한통운 사업자등록번호 110-81-0503))</li>
											</ul>
											<br />
						...
						<Fragment>
							...
							<div className="applyDtl_top ">
								<div className="applyDtl_cell ta_c pick">
									<h3>
										<strong>EVENT 3 - </strong> 신규 회원가입 이벤트
									</h3>
								</div>
							</div>
							<div className="vivasamter_apply">
								<div className="vivasamter_applyDtl type02 pdside0 ">
									...
									<div className="acco_notice_list mt0">
										<div className="acco_notice_cont">
											...
											<ul className="privacyList type02 ">
												<li>개인정보 수집 및 이용동의 이용 목적: 경품 발송 및 고객 문의 응대</li>
												<li>수집하는 개인 정보: 성명,휴대전화번호</li>
												<li>개인정보 보유 및 이용 기간: 2024년 4월 30일까지(이용목적 달성 시 즉시 파기)</li>
												<li>개인정보 오기재로 인한 경품 재발송은 불가능합니다. 개인정보를 꼭 확인해 주세요.</li>
												<li>경품 발송을 위한 개인정보(성함, 휴대 전화번호, 주소)가 배송업체 및 기프티콘 발송 서비스사에 제공됩니다. <br/>(㈜카카오 사업자등록번호 : 120-81-47521)/<br/>(㈜다우기술 사업자등록번호: 220-81-02810)/<br/>(㈜모바일이앤엠애드 사업자등록번호:215-87-19169)</li>
											</ul>
											<br />
											<p className="privacyTxt type02">선생님께서는 개인정보의 수집 및 이용, 처리 위탁에 대한 동의를 거부할 수 있습니다. 단, 동의를 거부할 경우 이벤트 참여가 불가합니다.</p>
										</div>
