	...
	insertApplyForm = async () => {
		...
		try {
			...
			var params = {
				...
				eventAnswerDesc2: eventAnswer.giftName + '^||^' + eventAnswer.eventAnswerDesc,
			...
			<section className="vivasamter">
				...
				<div className="applyDtl_top">
					<div className="applyDtl_cell ta_c pick">
						<h3><strong>Full수록 신청하기</strong></h3>
					</div>
				</div>
					...
					<div className="vivasamter_applyDtl pdside0">
						...
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList">
									<li>이용목적: 풀수록 교재 발송</li>
									<li>수집하는 개인정보: 성명, 학교명, 학교주소, 휴대폰 번호</li>
									<li>개인정보 보유 및 이용기간: 2021년 10월 30일까지<br />(이용목적 달성 시 즉시 파기)</li>
									<li>수집하는 개인정보의 처리 위탁: 자료 발송을 위해 개인정보(성명, 학교주소, 휴대폰 번호)를 배송업체에 취급 위탁<br />(㈜한진 사업자등록번호:201-81-02823)</li>
								</ul>
								<br />
						...
						<div className="checkbox_circle_box mt25 pdside20">
							...
							<label
								...
								className="checkbox_circle_simple">
								<strong className="checkbox_circle_tit">
									선택 교재와 수령 주소를 정확히 확인하였습니다.<br />(본 이벤트는 주소지 변경, 교재 교환이 불가합니다.)
								</strong>
							</label>
						</div>
						<button
