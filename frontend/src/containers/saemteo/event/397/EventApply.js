...
class EventApply extends Component {
	...
	render() {
		...
		return (
			<section className="vivasamter event220314">
				<h2 className="blind">
					비바샘터 신청하기
				</h2>
				<div className="applyDtl_top">
					<div className="applyDtl_cell ta_c pick">
						<h3><strong>비상.한.컷 이벤트</strong> 신청하기</h3>
					</div>
				</div>
				<div className="vivasamter_apply1">
					<div className="vivasamter_applyDtl pdside0">
						...
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList">
									...
									<li>선물 발송을 위해 개인정보(성명, 학교주소, 휴대전화번호)가 배송업체에 제공됩니다.<br/>(㈜한진 사업자등록번호 : 201-81-02823)</li>
								</ul>
								<br />
						...
						<button
							...
							className="btn_full_on mt35">신청 하기
						</button>
					</div>
				</div>
			</section>
