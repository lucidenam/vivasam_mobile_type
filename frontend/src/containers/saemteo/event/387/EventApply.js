...
class EventApply extends Component {
	...
	componentDidMount() {
		...
		else if (!eventAnswer.eventAnswerDesc1) {
			...
			<section className="vivasamter">
				...
				<div className="applyDtl_top">
					<div className="applyDtl_cell ta_c pick">
						<h3>‘웰컴 투 비바샘’ <strong>신청하기</strong></h3>
					</div>
				</div>
				<div className="vivasamter_apply">
					<div className="vivasamter_applyDtl pdside0">
						<div className="pdside20 pb25">
							...
							{event.userInfo == 'Y' && <p className="bulTxt mb15 mt10 ml10">* 학교 주소 및 수령처를 정확히 기입해 주세요.</p>}
							{event.userInfo == 'Y' && <p className="bulTxt mb15 mt10 ml10">* 잘못 기재된 주소 정보로 인해 반송된 선물은 재발송되지 <br/><span className="ml8">않습니다.</span></p>}
						</div>
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList">
									...
									<li>선물 발송을 위해 개인정보(성명, 휴대전화번호, 주소)가 배송업체에 제공됩니다.</li>
									<li>((주)모바일이앤엠애드 사업자등록번호 215-87-19169) <br/>((주)한진 사업자등록번호 201-81-02823)</li>
								</ul>
								<br />
						...
						<button
							...
							className="btn_full_on mt35">신청완료
						</button>
					</div>
				</div>
			</section>
