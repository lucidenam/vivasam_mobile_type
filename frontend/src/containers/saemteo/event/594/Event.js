...
class Event extends Component {
  ...
  eventApply = async (e) => {
    ...
    if(evtComment.trim() === '' || evtComment.length < 20) {
  ...
  commentConstructorList = async () => {
    ...
    this.setState({
      leaveCnt : (this.state.eventAnswerCount - this.state.pageSize),
  ...
  render() {
    const {eventAnswerContents, eventAnswerCount, pageNo, pageSize, bookTitle, bookReason, eventViewAddButton, evtComment, leaveCnt} = this.state;
    ...
    return (
      <section className="event250915">
        <div className="evtCont01">
          <h1><img src="/images/events/2025/event250915_2/img1.png" alt="위인의 생각을 쓰다"/></h1>
        </div>
        <div className="evtContWrap">
          <div className="evtCont02">
            <h1><img src="/images/events/2025/event250915_2/img2.png" alt="미리보기"/></h1>
          ...
          {eventAnswerCount > 0 &&
            <div className="commentWrap cont_Wrap">
              ...
              <div className="btnMoreWrap" style={{ display : eventViewAddButton == 1 ? 'block' : 'none' }}>
        ...
        <div className="evtNotice">
          ...
          <ul>
            ...
            <li>정확한 주소를 기입해 주세요. <br/>(학교 주소, 수령처 포함: ex. 교무실, 행정실, 학년 반, 경비실 등)</li>
            <li>정보 오기재 시 재발송이 불가능합니다.</li>
