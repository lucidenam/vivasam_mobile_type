...
class EventApply extends Component {
    ...
    applyButtonClick = (target) => {
        ...
        try {
            // applyContent 확인
            if(eventAnswer.eventAnswerContent.applyContent === ''){
                common.error("선택(입력)정보가 없습니다. 다시 선택(입력) 해주세요.");
                history.push('/saemteo/event/view/'+eventId);
                return false;
            }
            event.applyContent = eventAnswer.eventAnswerContent.applyContent;
            ...
            <section className="vivasamter">
                ...
                <div className="applyDtl_top">
                    <div className="applyDtl_cell pick ta_c">
                        <h3><strong>비바샘 X 선생님</strong> 이벤트의 탄생</h3>
                    </div>
                </div>
                <div className="vivasamter_apply">
                    <div className="vivasamter_applyDtl">
                        ...
                        <h2 className="info_tit">
                            <label htmlFor="ipt_schname">학교 정보</label>
                        </h2>
                        ...
                        <div className="acco_notice_list">
                            <div className="acco_notice_cont mt10">
                                ...
                                <ul class="policy">
                                    ...
                                    <li>- 수집하는 개인정보의 취급위탁 : 자료집 발송을 위해 개인정보<br />(이름/주소/연락처)를 배송업체에 취급 위탁<br />(㈜한진 사업자등록번호:201-81-02823)</li>
                                </ul>
