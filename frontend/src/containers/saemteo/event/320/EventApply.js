...
class EventApply extends Component {
    ...
    componentDidMount(){
        ...
        if((eventId == null) ||  (typeof eventId == "undefined") ||
            (eventAnswer.eventAnswerContent.applyName == null) ||  (typeof eventAnswer.eventAnswerContent.applyName == "undefined") ||
    ...
    applyButtonClick = (target) => {
        ...
        try {
            if((eventAnswer.eventAnswerContent.applyName === '') || (eventAnswer.eventAnswerContent.applyContent === '')){
                common.error("선택(입력)정보가 없습니다. 다시 선택(입력) 해주세요.");
                history.push('/saemteo/event/view/'+eventId);
                return false;
            }
    ...
    insertApplyForm = async () => {
        ...
        try {
            ...
            if(response.data.code === '1'){
                ...
                event.eventAnswerDesc = eventAnswer.eventAnswerContent.applyName+'^||^'+eventAnswer.eventAnswerContent.applyContent; // 사연
            ...
            <section className="vivasamter">
                ...
                <div className="applyDtl_top">
                    <div className="applyDtl_cell pick">
                        <h3><img src="/images/events/2020/event201201/txt_poptit.png" alt="수고했어, 경자씨!" /></h3>
                    </div>
                </div>
