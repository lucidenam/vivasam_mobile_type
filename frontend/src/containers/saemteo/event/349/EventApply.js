...
class EventApply extends Component {
    ...
    insertApplyForm = async () => {
        const { event, history, SaemteoActions, PopupActions, MyclassActions, BaseActions, eventId } = this.props;
        
        try {
            BaseActions.openLoading();
            event.eventId = eventId;
            event.amountYn = 'Y';   /* 수량제한 신청 */
            event.eventAnswerDesc2 = '1';   /* 관리자 신청목록 내용1로 기록 */
            event.applyContentTotCnt = '1';     /* 상품 종류 수 */
            event.applyContentNumbers = '3';    /* 상품 seq, 복수신청시는 csv(3,4,5) */
            event.applyTargetContentCnt = '1';  /* 상품 신청수량, 복수신청시는 csv(0,1,1) */
            ...
            <section className="vivasamter">
                ...
                <div className="applyDtl_top">
                    <div className="applyDtl_cell">
                        <h3>미래형 신직업을 한눈에 볼 수 있는<br/><strong className="eventSubTit">2021 진로 브로마이드</strong></h3>
                    </div>
                </div>
                    ...
                    <div className="vivasamter_applyDtl">
                        ...
                        <div className="acco_notice_list">
                            <div className="acco_notice_cont mt10">
                                <span className="acco_notice_tit info_tit pb10">진로 브로마이드 배송 관련</span>
                                <ul className="policy">
                                    <li className="bulTxt">진로 브로마이드는 선생님 재직 학교의 인근 비상교육 지사를 통해 전달할 예정입니다. 재직 학교를 정확히 확인해 주세요.</li>
                                    <li className="bulTxt">담당 지사에서 선생님께 직접 연락을 드릴 수 있으며, 담당 지사는 아래 링크를 통해 확인하실 수 있습니다.<br /><p>비상교육 지사 안내: <a href="https://book.visang.com/customer/subcompretrieve.aspx" target="_blank">https://book.visang.com/customer/subcompretrieve.aspx</a></p></li>
                                    <li className="bulTxt">담당 지사가 전달이 어려울 경우, 본사에서 택배 배송해 드립니다.</li>
                                </ul>
                            </div>
                        ...
                        <div className="acco_notice_list">
                            <div className="acco_notice_cont mt10">
                                ...
                                <ul className="policy">
                                    <li className="bulTxt">이용목적 : 진로 브로마이드 발송</li>
                                    <li className="bulTxt">수집하는 개인정보 : 성명, 재직 학교, 학교 소재지, 수령처, 휴대전화번호</li>
                                    <li className="bulTxt">개인정보 보유 및 이용기간 : 휴대전화번호는 2021년 7월 31일까지만 보유하며, 재직학교와 학교 소재지의 정보는 비바샘 개인정보에 갱신됩니다.</li>
                                    <li className="bulTxt">수집하는 개인정보의 취급위탁 : 진로 브로마이드 발송을 위해 개인정보(이름/주소/연락처)를 재직 학교 인근 비상교육 지사 및 배송업체에 취급 위탁<br />(배송업체: ㈜한진 사업자등록번호 201-81-02823)</li>
                                </ul>
