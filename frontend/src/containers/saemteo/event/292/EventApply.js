...
class EventApply extends Component {
    ...
    componentDidMount(){
        ...
        if((eventId == null) || (eventId == '') || (typeof eventId == 'undefined')){
    ...
    validateInfo = () => {
        ...
        } else if(this.state.applyContent.trim() === '') {
            obj.message = '사연을 작성해 주세요.';
        } else {
            obj.result = true;
        }
        return obj;
    ...
    insertApplyForm = async () => {
        ...
        try {
            ...
            if(response.data.code === '1'){
                ...
                event.eventAnswerDesc = this.state.applyContent; // 사연
                    ...
                    <div className="vivasamter_applyDtl">
                        ...
                        <div className="input_wrap mb25">
                            ...
                            <p className="phonecaption">
                                ＊5월 11일(월)에 재직하시는 학교 인근 꽃집에서 꽃이 배달됩니다.<br/>
                                ＊당첨되신 선생님께 꽃 배송 관련한 문자메시지를 보내드립니다.
                            </p>
                        </div>


                        <h2 className="info_tit txt_ls">
                            <label htmlFor="applyContent" className="bl">꽃을 선물하고 싶은 사람이 있다면, 사연을 남겨주세요.</label>
                        </h2>
                        ...
                        <div className="acco_notice_list">
                            ...
                            <div className="acco_notice_cont mt10">
                                <ul className="policy">
                                    <li>이용목적 : 선물 배송 및 문의 응대</li>
                                    <li>수집하는 개인정보 : 성명, 재직 학교, 휴대전화 번호</li>
                                    <li>개인정보 보유 및 이용 기간 : 2020년 5월 15일까지<br />
                                        (이용목적 달성 시 즉시 파기) </li>
                                    <li>주소 및 연락처 기재 오류로 반송된 선물은 재 발송되지 않습니다.<br />
                                        개인정보를 꼭 확인해주세요.</li>
                                    <li>선물 발송을 위해 개인정보(성명/재직 학교/휴대전화 번호)가 꽃집에 제공됩니다.</li>
                                </ul>
