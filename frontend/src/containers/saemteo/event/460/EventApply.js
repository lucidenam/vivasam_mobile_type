...
class EventApply extends Component {
	...
	render() {
		...
		const {event} = this.props;
		const {phoneCheckMessage, phoneCheckClassName, windowWidth} = this.state;
			...
			<section className="vivasamter">
				...
				<div className="applyDtl_top topStyle2">
					<div className="applyDtl_cell ta_c pick">
						<h3><strong>채안지 메이커 브로마이드 배포 이벤트</strong> 신청하기</h3>
					</div>
				</div>
					...
					<div className="vivasamter_applyDtl type02 pdside0">
						<div className="pdside20 pb25">
							<h2 className="info_tit tit_flex">
								...
								<div className={"input_wrap " + (windowWidth ? "teacher_name" : ' ')}>
									<input
										type="text"
							...
							<div className="input_wrap school_wrap style2">
								<input
									...
									id="ipt_school_name"
									name="schName"마케팅 및 광고 활용 동의마케팅 및 광고 활용 동의
									onChange={this.handleChange}
									value={event.schName}
						...
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList">
									...
									<li>
										개인정보 보유 및 이용기간 : 2023년 9월 30일까지<br />
										(이용목적 달성 시 즉시 파기)
									</li>
									<li>
						...
						<div className="checkbox_circle_box mt25 pdside20">
							...
							<label
								...
								<strong className="checkbox_circle_tit">
									본인은 개인정보 수집 및 이용동의 안내를 확인하였으며,<br />
									이에 동의합니다.
								</strong>
							</label>
						</div>
						<button
							...
							className="btn_event_apply btn_c2 mt35">신청하기
						</button>
					</div>
				</div>
			</section>
