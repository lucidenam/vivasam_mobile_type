...
class Event extends Component {
    ...
    eventCheckAmount = async () => {
        ...
        if (response.data.eventAnswerCount < 250) { // 해당된 수량만큼 제한
            this.setState({
                eventApplyCheck: 1
            });
        }
        ...
        try {
            ...
            if(response.data.code === '0'){
                if(!navigator.userAgent.match(/Android|Mobile|iP(hone|od|ad)|BlackBerry|IEMobile|Kindle|NetFront|Silk-Accelerated|(hpw|web)OS|Fennec|Minimo|Opera M(obi|ini)|Blazer|Dolfin|Dolphin|Skyfire|Zune/)){
                    window.open("https://forms.gle/4LZLFPx4nXKojnw76", "_blank");
                }else{
                    window.location.href = "https://forms.gle/4LZLFPx4nXKojnw76";
                }
    ...
    render() {
        return (
            <section className="event191028">
                <h1><img src="/images/events/2019/event191028/img2.jpg" alt="비상교육 초등 교수자료 개발을 위한 설문 (교과별 특혀좌료 조사)"/>
                </h1>
                <div className="blind">
                    <dl>
                        <dt>설문 기간</dt>
                        <dd>2019년 10월 31일(목) ~ 선착순 마감</dd>
                        <dt>참여 대상</dt>
                        <dd>초등학교 선생님</dd>
                        <dt>참여 선물</dt>
                        <dd>설문 참가자 전원(250명) / 스타벅스 카페라떼 tall 기프티콘</dd>
                    </dl>
                </div>
                <div className="cont_top">
                    <p>
                        안녕하세요.<br/>
                        저희 비상교육에서는 초등학교급 교수학습자료 개발을 앞두고, <br/>
                        선생님들께 의견을 구하고자 설문을 실시하게 되었습니다.
                    </p>
                    <p>
                        본 설문은 <em>수학, 사회, 과학 수업 시간에 사용하는 디지털 콘텐츠</em>에 <br/>
                        대해 알아보는 조사로, 향후 비상교육에서 개발할 다양한 콘텐츠의 <br/>
                        기초 자료가 될 것입니다.
                    </p>
                ...
                <dl className="agree_info">
                    ...
                    <dd>
                        <ul>
                            ...
                            <li>- 수집하는 개인정보의 취급 위탁 : 경품 발송을 위해 휴대전화번호 <br/>정보를 기프티콘 발송 업체에 취급 위탁 <br/>(㈜다우기술-사업자:220-81-02810)
                            </li>
                        </ul>
                    </dd>
                </dl>
