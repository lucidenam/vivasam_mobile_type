...
class EventApply extends Component {
	...
	validateInfo = () => {
		...
		} else if (this.state.isSetMemberCount < 10) {
			obj.message = '최소 10 ~ 최대 40명까지 신청할 수 있어요.';
			...
			<section className="vivasamter">
				...
				<div className="applyDtl_top top_yell">
					<div className="applyDtl_cell ta_c pick">
						<h3><span>2025년 2학기 꿈지기 캠페인</span><br /> 꿈 명함 만들기 프로젝트</h3>
					</div>
				</div>
					...
					<div className="vivasamter_applyDtl pdside0">
						<div className="pdside20 pb25">
							...
							<p className="mt10 mb25 c_gray">
								...
								<span className="ml8">(40명 이하만 가능)</span>
							</p>
						...
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList">
									<li>학급, 동아리 40명 이하 그룹 단위로만 신청 가능합니다.</li>
									<li>구체적인 꿈 명함 활동 계획을 알려주시면 당첨 확률이 올라갑니다.</li>
									<li>당첨되신 선생님께 꿈 명함 제작을 위한 정보를 요청 드립니다.</li>
									<li>’꿈지기 생생후기’ 게시판에 후기 <strong>사진 게재를 위해 사진을 수급합니다. 후기 수급에 동의하지 않을 시 참여가 어렵습니다.</strong></li>
									<li>꿈 명함 수령 후 <strong>만족도 조사 및 후기 작성에 꼭 참여해 주세요.</strong></li>
								</ul>
							</div>
						</div>
						...
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList">
									...
									<li>개인정보 보유 및 이용 기간 : 2025년 캠페인 종료 시까지 (이용목적 달성 시 즉시 파기)</li>
									<li>선물 발송을 위해 개인정보(성명/주소/연락처)가 배송업체에 제공됩니다. 후기 수급에 동의하지 않을 시 참여가 어렵습니다. (주)다우기술 사업자등록번호 220-81-02810, (주)한진 사업자등록번호 201-81-02823<br/></li>
								</ul>
						...
						<div className="checkbox_circle_box mt25 pdside20">
							...
							<label
								htmlFor="join_agreeN"
								className="checkbox_circle_simple ml20">
								<strong className="checkbox_circle_tit">
									동의하지 않음
								</strong>
							</label>
