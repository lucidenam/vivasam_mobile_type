    ...
    insertApplyForm = async () => {
        ...
        try {
            ...
            if(response.data.code === '1'){
                ...
                // Web과의 싱크를 맞춰주기 위해서 2,3번째 응답도 똑같이 맞춰준다.
                ...
                event.eventAnswerDesc = '장르 : ' + eventAnswer.eventAnswerContent.Q1 + " / 수업 : " +  eventAnswer.eventAnswerContent.Q2; // 질문 응답 ( 해당되는 JSON의 Key를 이용해 Value를 가져온다. )
            ...
            <section className="vivasamter">
                ...
                <div className="applyDtl_top">
                    <div className="applyDtl_cell">
                        <h3>비바샘 + 설렘꾸러미 캠페인</h3>
                        <p>설렘꾸러미는 입력된 학교 주소로 배송됩니다.<br />학교 번지수 및 수령처 등을 정확하게 입력해 주세요.</p>
                    </div>
                </div>
                    ...
                    <div className="vivasamter_applyDtl">
                        ...
                        <div className="acco_notice_list">
                            ...
                            <div className="acco_notice_cont mt10">
                                <ul class="policy">
                                    <li>- 이용목적 : 경품 발송</li>
                                    <li>- 수집하는 개인정보 : 이름, 학교명, 학교 주소, 연락처</li>
                                    <li>- 개인정보 보유 및 이용기간 : 2019년 12월30일까지 (이용목적 달성 시 즉시 파기)</li>
                                    <li>- 수집하는 개인정보의 취급위탁 : 이벤트 경품발송을 위해 개인정보(이름/주소/연락처)를 배송업체에 취급 위탁 (롯데글로벌로지스(주) - 사업자등록번호 : 102-81-23012</li>
                                </ul>
                            </div>
