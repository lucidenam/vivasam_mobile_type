...
class Event extends Component{
    ...
    render () {
        return (
            <section className="event190619">
                <h1><img src="/images/events/2019/event190619/img.jpg" alt=""/></h1>
                <div className="blind">
                ...
                <div className="cont">
                    ...
                    <img src="/images/events/2019/event190619/img2.jpg" alt="색으로 덮인 아름다운 세상"/>
                    <img src="/images/events/2019/event190619/img3.jpg" alt="어린이 헌장"/>
                    <div className="btn_wrap">
                        <button type="button" id="eApply" className="btn_apply" onClick={this.eventApply}><img
                            src="/images/events/2019/event190619/btn_apply.png" alt="신청하기"/></button>
                    </div>
                </div>
                <div className="cont2">
                    <ul>
                        <ul>
                            <li><strong>1인 1회, 1세트까지 신청 가능</strong>합니다. (추가 수량 문의 : 02-6970-5753)</li>
                            <li>선착순 신청으로, 수량 소진 시 조기 마감될 수 있습니다. (6월 24일부터 순차 배송)</li>
                            <li>정확한 주소를 기입해주세요. (학교 번지수, 수령처 포함 : ex.교무실, 진로상담실, 행정실, 학년 반, 경비실 등)</li>
                            <li>주소 기재가 잘못되어 반송된 브로마이드는 재발송 되지 않습니다.</li>
                            <li>신청자 개인정보(성명/주소/휴대전화번호)는 배송업체에 공유됩니다. <br />(CJ대한통운(주) / 사업자등록번호 : 110-81-05034)</li>
                        </ul>
                    </ul>
                </div>
            </section>
