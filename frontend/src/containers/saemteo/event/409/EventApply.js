...
class EventApply extends Component {
	...
	applyButtonClick = (target) => {
		...
		try {
			...
			event.eventAnswerDesc2 = "진로 브로마이드 신청";
			SaemteoActions.pushValues({type: "event", object: event});
			// 신청 처리
	...
	insertApplyForm = async () => {
		...
		try {
			...
			var params = {
				...
				amountYn: 'Y',   /* 수량제한 신청 */
				applyContentTotCnt: '1',     /* 상품 종류 수 */
				applyContentNumbers: '3',    /* 상품 seq, 복수신청시는 csv(3,4,5) */
				applyTargetContentCnt: '1'
			};
	...
	render() {
		...
		return (
			<section className="vivasamter evt220627">
				<h2 className="blind">
					비바샘터 신청하기
				</h2>
				<div className="applyDtl_top bg_yell">
					<div className="applyDtl_cell ta_c">
						<h3><strong>2022 진로 브로마이드 신청하기</strong></h3>
					</div>
				</div>
				<div className="vivasamter_apply">
					<div className="vivasamter_applyDtl pdside0">
						...
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList">
									<li>이용목적 : 진로탐색 브로마이드 발송</li>
									<li>수집하는 개인정보 : 성명, 재직학교, 학교 주소, 휴대전화번호</li>
									<li>개인정보 보유 및 이용기간 : 2022년 7월 31일까지 <br/>
										(이용목적 달성 시 즉시 파기)</li>
									<li>
										수집하는 개인정보의 취급위탁 : <span className="c_o"> 브로마이드 발송을 위해 <br/>
										개인정보(성명, 학교주소, 휴대전화번호)를 배송업체<br/>
										(㈜CJ대한통운 사업자등록번호 : 110-81-05034)에 취급 위탁</span>
									</li>
								</ul>
								<br />
						...
						<div className="checkbox_circle_box pdside20 acco_notice_list">
							<div className="acco_notice_cont">
								<input
									type="checkbox"
									name="agree"
