			...
			<section className="vivasamter">
				...
				<div className="applyDtl_top">
					<div className="applyDtl_cell ta_c pick">
						<h3><strong>&lt;위인의 생각을 쓰다&gt;</strong> 필사 노트 배포 이벤트</h3>
					</div>
				</div>
						...
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList">
									<li>필사 노트는 선생님 재직 학교의 인근 비상교육 지사를 통해 전달할 예정입니다. 재직 학교를 정확히 확인해 주세요.</li>
									<li>담당 지사에서 선생님께 직접 연락을 드릴 수 있습니다.</li>
									<li>담당 지사는 아래 링크를 통해 확인하실 수 있습니다.</li>
								</ul>
								<br />
								<p className="privacyTxt">비상교육 지사 안내:<br/><a href="javascript:void(0);" onClick={() => this.openBranchUrl('https://book.visang.com/customer/subcompretrieve.aspx?deviceMode=pc')} target="_blank">https://book.visang.com/customer/subcompretrieve.aspx</a></p>
							</div>
						</div>
						...
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList">
									...
									<li>수집하는 개인정보의 처리 위탁: 자료 발송을 위해 개인정보(성명, 학교주소, 휴대폰 번호)를 재직 학교 인근 비상교육 지사에 처리 위탁<br />(㈜한진 사업자등록번호:201-81-02823)</li>
								</ul>
								<br />
