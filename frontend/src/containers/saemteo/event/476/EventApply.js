			...
			<section className="vivasamter">
				...
				<div className="applyDtl_top">
					<div className="applyDtl_cell ta_c pick">
						<h3><strong>2024 교무 수첩 & 탁상 달력</strong> 신청하기</h3>
					</div>
				</div>
						...
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList">
									<li>이용 목적 : 경품 배송 및 고객문의 응대​</li>
									<li>수집하는 개인정보 : 성명, 재직학교,휴대전화번호 ​</li>
									<li>개인정보 보유 및 이용기간 : 2024년 1월 31일까지​</li>
									<li>연락처 및 주소 미기재, 오기재 시 경품 재발송이 불가능합니다 <br/>입력하신 개인정보를 꼭 확인해 주세요.​</li>
									<li>경품 발송을 위해 개인정보(성명, 휴대전화번호,주소)가 서비스사에 제공됩니다.<br />(㈜CJ대한통운 사업자등록번호 : 110-81-05034)​</li>
								</ul>
								<br />
