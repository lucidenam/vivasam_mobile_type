...
class EventApply extends Component {
    ...
    componentDidMount = async() => {
        ...
        } else if (!eventAnswer || !eventAnswer.answer1 || !eventAnswer.applyContent) {
            // 이벤트 관련 질문에 대한 답변이 없으면 이젠트 조회 페이지로 이동
    ...
    applyButtonClick = (target) => {
        ...
        try {
            ...
            event.eventAnswerDesc2 = eventAnswer.answer1 + '^||^' + eventAnswer.applyContent;
            SaemteoActions.pushValues({type:"event", object:event});
            // 신청 처리
                ...
                <div className="vivasamter_apply">
                    <div className="vivasamter_applyDtl">
                        ...
                        <p className="mb25 pointColor">
                            ...
                            * 잘못 기재된 주소 정보로 인해 반송된 선물은 재발송 되지 않습니다.
                        </p>
                        <div className="acco_notice_list">
                            <div className="acco_notice_cont mt10">
                                ...
                                <ul className="policy">
                                    <li className="bulTxt">이용목적 : 샘퀴즈 온 더 블럭 이벤트 운영 및 경품 발송</li>
                                    <li className="bulTxt">수집하는 개인정보 : 성명, 재직 학교, 학교 소재지, 수령처, 휴대전화번호</li>
                                    <li className="bulTxt">개인정보 보유 및 이용기간 : 휴대폰전화번호는 2021년 7월 30일까지만 보유하며, 재직 학교와 학교 소재지의 정보는 비바샘 개인정보에 갱신됩니다.</li>
                                    <li className="bulTxt">수집하는 개인정보의 취급위탁 : 경품 발송을 위해 개인정보(이름/주소/연락처)를 업체에 취급 위탁<br />(㈜한진 사업자등록번호 : 201-81-02823)<br />(㈜다우기술 사업자등록번호 : 220-81-02810)</li>
                                </ul>
