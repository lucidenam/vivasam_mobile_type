...
class EventApply extends Component {
    ...
    validateInfo = () => {
        ...
        if(!event.userName){
            ...
            obj.message = '캠페인 내용 확인 여부를 체크해 주세요.';
                ...
                <div className="vivasamter_apply">
                    <div className="vivasamter_applyDtl">
                        ...
                        <h2 className="info_tit txt_ls mt25">
                            <label htmlFor="applyContent">학생들에게 꿈 명함을 선물하고 싶은 이유를 적어주세요.</label>
                        </h2>
                        <div className="input_wrap">
                            <textarea
                                name="applyContent"
                                ...
                                placeholder="400자 까지 입력하실 수 있습니다."
                                className="textarea">
                            </textarea>
                            <div className="count_wrap mb25">
                                <p className="c_gray">※ 진심이 있는 사연이라면 분량에 상관없이<br />선정하겠습니다.</p>
                        ...
                        <div className="linebox mb25">
                            ...
                            <div className="checkbox_circle_box mt10">
                                ...
                                <label
                                    ...
                                    className="checkbox_circle_simple">
                                    <strong className="checkbox_circle_tit c_gray">
                                        꿈지기 캠페인 당첨 시, 후기 사진을 제출하고 이를 비바샘 사이트에 탑재하는 것에 동의합니다. <em className="txt_point">(제출하신 사진은 상업적인 용도로 활용되지 않습니다.)</em>
                                    </strong>
                                </label>
                            </div>
                        </div>
                        ...
                        <div className="acco_notice_list">
                            ...
                            <div className="acco_notice_cont mt10">
                                <ul className="policy">
                                    <li>- 이용목적 : 2019 비바샘 꿈지기 캠페인 경품 배송 및 고객 문의 응대</li>
                                    <li>- 수집하는 개인정보 : 성명, 배송지 정보, 휴대전화번호, 이메일 등</li>
                                    <li>- 개인정보 보유 및 이용기간 : 캠페인 종료시까지 (이용목적 달성 시 즉시 파기)</li>
                                </ul>
                            </div>
                            <div className="checkbox_circle_box mt10">
                                <input
