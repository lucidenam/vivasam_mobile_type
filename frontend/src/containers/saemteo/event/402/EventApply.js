			...
			<section className="vivasamter">
				...
				<div className="applyDtl_top">
					<div className="applyDtl_cell ta_c">
						<h3><strong>사회 브로마이드 발송 이벤트</strong></h3>
					</div>
				</div>
						...
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList">
									<li>이용목적 : 초등 사회 활동 자료 발송</li>
									<li>수집하는 개인정보 : 성명, 학교명, 학교 주소, 연락처</li>
									<li>개인정보 보유 및 이용기간 : 2022년 4월 30일까지 <br/>
										(이용목적 달성 시 즉시 파기)</li>
									<li>수집하는 개인정보의 취급위탁 : 자료집 발송을 위해 <br/>
										개인정보(이름/주소/연락처)를<br/>
										(㈜CJ대한통운 사업자등록번호 : 110-81-05034)에 취급 위탁</li>
								</ul>
								<br />
