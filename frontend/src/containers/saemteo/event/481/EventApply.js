            ...
            <section className="vivasamter">
                ...
                <div className="applyDtl_top ">
                    <div className="applyDtl_cell ta_c pick">
                        <h3>
                            <strong>Knock knock! 스마트 기기 똑똑! 하게 알아보기</strong>
                        </h3>
                    </div>
                </div>
                        ...
                        <div className="acco_notice_list pdside20 mt0">
                            <div className="acco_notice_cont">
                                ...
                                <ul className="privacyList type02 ">
                                    ...
                                    <li>개인정보 보유 및 이용기간 : 2024년 2월 29일까지 (이용목적 달성 시 즉시 파기)</li>
                                ...
                                <br/>
                                <p className="privacyTxt">선생님께서는 개인정보의 수집 및 이용, 처리 위탁에 대한 동의를 거부할 수 있습니다.
                                    <br />단, 동의를 거부할 경우
                                    이벤트 참여가 불가합니다.</p>
                            </div>
                        </div>
