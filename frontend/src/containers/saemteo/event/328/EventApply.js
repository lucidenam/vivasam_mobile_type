    ...
    insertApplyForm = async () => {
        ...
        try {
            ...
            if(response.data.code === '1'){
                ...
                throw new Error("수량이 모두 마감되었습니다.");
            }else{
                ...
                <div className="vivasamter_apply">
                    <div className="vivasamter_applyDtl">
                        ...
                        <p className="mb25 c_gray">
                            ...
                            * 잘못된 주소로 인해 반송된 상품은 재발송 되지 않습니다.
                        </p>
                        <div className="acco_notice_list">
                            <div className="acco_notice_cont mt10">
                                ...
                                <ul className="policy">
                                    ...
                                    <li>- 수집하는 개인정보의 취급위탁 : 자료 발송을 위해 개인정보(이름/주소/연락처)를 배송업체에 취급 위탁<br />(㈜한진 사업자등록번호:201-81-02823)</li>
                                </ul>
