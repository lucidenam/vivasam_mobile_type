...
class EventApply extends Component {
    ...
    componentDidMount(){
        ...
        if((eventId == null) ||  (typeof eventId == "undefined") ||
            (eventAnswer.eventAnswerContent.selContentNm == null) ||  (typeof eventAnswer.eventAnswerContent.selContentNm == "undefined") ||
            (eventAnswer.eventAnswerContent.applyContent == null) ||  (typeof eventAnswer.eventAnswerContent.applyContent == "undefined")
        ){
    ...
    applyButtonClick = (target) => {
        ...
        try {
            if((eventAnswer.eventAnswerContent.selContentNm === '') || (eventAnswer.eventAnswerContent.applyContent === '')){
                common.error("선택(입력)정보가 없습니다. 다시 선택(입력) 해주세요.");
                history.push('/saemteo/event/view/'+eventId);
                return false;
            }
    ...
    insertApplyForm = async () => {
        ...
        try {
            ...
            event.eventAnswerDesc2 = eventAnswer.eventAnswerContent.selContentNm+'^||^'+eventAnswer.eventAnswerContent.applyContent;
            ...
            <section className="vivasamter">
                ...
                <div className="applyDtl_top">
                    <div className="applyDtl_cell pick">
                        <h3><strong>&lt;Full수록&gt; 수학</strong> 신청하기</h3>
                    </div>
                </div>
                <div className="vivasamter_apply">
                    <div className="vivasamter_applyDtl">
                        ...
                        <h2 className="info_tit">
                            <label htmlFor="ipt_phone">유의사항</label>
                        </h2>
                        <p className="mb25 c_gray">
                        ...
                        <div className="acco_notice_list">
                            <div className="acco_notice_cont mt10">
                                ...
                                <ul class="policy">
	                                <li>- 이용목적 : 이벤트 참여 확인 및 상품 발송</li>
                                    <li>- 수집하는 개인정보 : 성명, 재직 학교, 학교 소재지, 휴대전화번호</li>
                                    <li>- 개인정보 보유 및 이용기간 : 2021년 03월 31일까지 <br/>(이용목적 달성 시 즉시 파기)</li>
                                    <li>- 수집하는 개인정보의 처리위탁 : 자료 발송을 위해 개인정보(이름/주소/연락처)를 배송업체에 처리 위탁<br />(㈜한진 사업자등록번호:201-81-02823)</li>
                                </ul>
