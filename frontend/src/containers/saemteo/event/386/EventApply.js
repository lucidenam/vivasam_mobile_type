				...
				<div className="vivasamter_apply">
					<div className="vivasamter_applyDtl pdside0">
						<div className="pdside20 pb25">
							...
							<div className={event.userInfo === 'Y' ? 'input_wrap mb10' : 'input_wrap mb25'}>
								<input
									type="text"
							...
							{event.userInfo == 'Y' && <p className="bulTxt mb15 ml10">* 학교 검색에서 찾으시는 학교가 없을 경우,<br/><span className="ml10">직접 입력을 통해 재직학교와 주소를 입력해 주세요.</span></p>}
							<h2 className="info_tit">
						...
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList">
									...
									<li>개인정보 보유 및 이용기간: 2022년 2월 28일까지<br />(이용목적 달성 시 즉시 파기)</li>
									<li>연락처 오류 시 경품 재발송이 불가능합니다. 개인정보를 꼭 확인해 주세요.</li>
									<li>선물 발송을 위해 개인정보(성명, 휴대전화번호)가 배송업체에 제공됩니다.<br/>((주)다우기술 사업자등록번호 220-81-02810),<br/>((주)모바일이앤엠애드 사업자등록번호 215-87-19169)</li>
								</ul>
								<br />
