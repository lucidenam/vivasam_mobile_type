...
class EventApply extends Component {
	...
	render() {
		...
		return (
			<section className="vivasamter event240429">
				<h2 className="blind">
					비바샘터 신청하기
				</h2>
				<div className="applyDtl_top bg_pink">
					<div className="applyDtl_cell ta_c pick">
						<h3>We are Challengers!</h3>
					</div>
				</div>
				<div className="vivasamter_apply1">
					<div className="vivasamter_applyDtl pdside0">
						<div className="pdside20 pb25">
							...
							<h2 className="info_tit">
								<label htmlFor="ipt_studentCnt">학급 학생 수</label>
							</h2>
							<div className="input_wrap">
								<input
									type="number"
						...
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList">
									...
									<li>수집하는 개인정보 : 성명, 재직 학교, 휴대전화번호​, 학교 주소, 수령처​ ※ 학교 주소와 학급 학생 수, 수령처는 이벤트 2 당첨 시 상품을 발송하기 위해 수집합니다.​</li>
									<li>개인 정보 보유 및 이용 기간: 2024년 6월 30일까지(이용 목적 달성 시 즉시 파기)​</li>
									<li>개인 정보 오기로 인한 경품 재발송은 불가능합니다. 개인 정보를 꼭 확인해 주세요.​</li>
									<li>경품 발송을 위해 개인 정보가 서비스사와 배송 업체에 제공됩니다.​ <br/>(주)모바일이앤엠애드 사업자등록번호 : 215-87-19169​ / 아기자기 선물가게 사업자등록번호: 530-31-00427 / 우체국 택배 사업자등록번호: 206-83-02050</li>
