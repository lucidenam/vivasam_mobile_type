	...
	insertApplyForm = async () => {
		...
		try {
			...
			var params = {
				...
				amountYn: 'Y',   /* 수량제한 신청 */
				applyContentTotCnt: '9',     /* 상품 종류 수 */
				applyContentNumbers: '3,4,5,6,7,8,9,10,11',    /* 상품 seq, 복수신청시는 csv(3,4,5) */
								...
								<ul className="join_ipt_chk">
									...
									<li className="join_chk_list half">
										<input
											...
											onChange={this.handleUserInfo}
										/>
										<label htmlFor="userInfoN">자택(직접입력)</label>
									</li>
								</ul>
							</h2>
							<h2 className="info_tit">
						...
						<div className="acco_notice_list pdside20 ">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList event2">
									...
									<li>개인 정보 보유 및 이용 기간: 2024년 9월 30일까지(이용 목적 달성 시 즉시 파기)</li>
									<li>개인 정보 오기로 인한 경품 재발송은 불가능합니다. 개인 정보를 꼭 확인해 주세요.</li>
									<li>신청자 개인 정보(성명/주소/휴대 전화 번호)가 배송 업체에 공유됩니다. <br/>㈜CJ대한통운 사업자번호: 110-81-05034 / ㈜한진택배 사업자등록번호: 201-81-02823</li>
								</ul>
								<br />
