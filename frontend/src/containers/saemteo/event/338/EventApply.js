...
class EventApply extends Component {
    ...
    state = {
        ...
        contentTitle : ['3~4학년 수학','3~4학년 사회','3~4학년 과학'],
    ...
    insertApplyForm = async () => {
        ...
        if(result){
            common.info('선택하신 자료집의 신청 수량이 마감되었습니다.');
            history.push('/saemteo/event/view/'+eventId);
        }else{
            try {
                ...
                event.applyContentTotCnt = '3';
                event.applyContentNumbers = '3,4,5';
                ...
                if(response.data.code === '1'){
                    ...
                    throw new Error("선택하신 자료집 신청 수량이 마감되었습니다.");
                }else{
                    ...
                    <div className="vivasamter_applyDtl">
                        ...
                        <div className="acco_notice_list">
                            <div className="acco_notice_cont mt10">
                                ...
                                <ul class="policy">
                                    <li>• 질문이 살아있는 수업 자료집은 선생님 재직 학교의 인근 비상교육 지사를 통해 전달할 예정입니다. 재직 학교를 정확히 확인해 주세요.</li>
                        ...
                        <div className="acco_notice_list">
                            <div className="acco_notice_cont mt10">
                                ...
                                <ul class="policy">
                                    ...
                                    <li>• 수집하는 개인정보의 취급위탁 : 자료집 발송을 위해 개인정보(이름/주소/연락처)를 재직 학교 인근 비상교육 지사에 취급 위탁</li>
                                </ul>
                        ...
                        <button
                            ...
                            className="btn_full_on2 mt35">신청하기</button>
                    </div>
                </div>
            </section>
