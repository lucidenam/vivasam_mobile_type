  ...
  insertApplyForm = async () => {
    ...
    try {
      ...
      var params = {
        ...
        eventAnswerDesc2: onePick + '^||^' + event.eventAnswerDesc2,
            ...
            <div className="vivasamter_applyDtl pdside0 type02">
              <div className="applyDtl_inner pdside20 pt25 pb25">
                ...
                <h2 className="info_tit not_essential">
                  <label htmlFor="ipt_textarea">선생님의 비바샘 원픽</label>
                </h2>
                <div className="select_wrap mt5">
                  <div className="selectbox select_sm">
                    <select name="dateSelect" id={"dateSelect"} onChange={this.setOnePick}>
                      <option value="비상교과서" selected={this.state.onePick === '비상교과서'}>비상교과서</option>
                      <option value="비상 AI 디지털교과서" selected={this.state.onePick === '비상 AI 디지털교과서'}>비상 AI 디지털교과서</option>
                      <option value="교과 자료" selected={this.state.onePick === '교과 자료'}>교과 자료</option>
                      <option value="에듀테크 테마관" selected={this.state.onePick === '에듀테크 테마관'}>에듀테크 테마관</option>
                      <option value="샘스토리" selected={this.state.onePick === '샘스토리'}>샘스토리</option>
                      <option value="비버샘" selected={this.state.onePick === '비버샘'}>비버샘</option>
                      <option value="교사문화 프로그램" selected={this.state.onePick === '교사문화 프로그램'}>교사문화 프로그램</option>
                      <option value="꿈지기 캠페인" selected={this.state.onePick === '꿈지기 캠페인'}>꿈지기 캠페인</option>
                    </select>
                  </div>
                </div>
                <h2 className="info_tit not_essential">
                  <label htmlFor="ipt_textarea">원픽으로 고른 이유</label>
                </h2>
                <div className="input_wrap">
												<textarea
                          name="applyContent"
              ...
              <div className="acco_notice_list pdside20">
                <div className="acco_notice_cont">
                  ...
                  <ul className="privacyList">
                    ...
                    <li>선물 발송을 위해 개인정보(성명, 휴대전화번호)가 서비스사와 배송업체에 제공됩니다.<br />(㈜카카오 사업자등록번호 : 120-81-47521) / (㈜모바일이앤엠애드 사업자등록번호:215-87-19169)</li>
                  </ul>
                </div>
              </div>
