	...
	applyButtonClick = (target) => {
		...
		try {
			...
			if (this.state.isSetGroupCheck === "1") {
				event.eventAnswerDesc = event.schName + '|^| ' + event.schAddr + " " + event.addressDetail + '|^| ' +eventCellPhone[0] + '-' + eventCellPhone[1] + '-' + eventCellPhone[2] + '|^| ' + this.state.eMailDomain + '@' + this.state.anotherEmailDomain;
			...
			<section className="vivasamter">
				...
				<div className="applyDtl_top">
					<div className="applyDtl_cell ta_c">
						<h3><strong>2022 비바샘 꿈지기 사연 </strong>신청하기</h3>
					</div>
				</div>
				<div className="vivasamter_apply">
					<div className="vivasamter_applyDtl pdside0">
						<div className="pdside20 pb25">
							...
							<h2 className="info_tit chk_tit">
								<label htmlFor="ipt_name">재직 학교</label>
					...
					<h2 className="info_tit chk_tit">
							...
							{   /* 학급인 경우 경우 출력 */
								...
								<div className="input_wrap receiveGradeClass mt5">
									<input
										type="number"
										maxLength="5"
										name="receiveGrade"
							...
							<p className="mt10 mb25 evtForm_labelTxt">* 꿈지기 선생님을 포함하여 총 인원을 기재하여 주세요.<br/>
								(40명 이내만 가능)</p>
							...
							<p className="mb10 txt_info">꿈 명함을 신청하시는 사연을 남겨 주세요.<br/>
								구체적인 꿈 명함 활용 계획을 남겨주시면 당첨 확률이 올라갑니다.
							</p>
							<div className="input_wrap">
								<textarea
									name="applyContent"
						...
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList">
									...
									<li>당첨되신 선생님께 꿈 명함 제작을 위한 정보를 요청드립니다.</li>
									<li>&lt;꿈지기 생생후기&gt; 게시판에 후기 사진 게재를 위하여<br/>
										<strong>학생들의 초상권 활용 동의서</strong>를 수급합니다.
										<p className="noti_txt">* 학생들의 초상권 동의를 받지 못할 경우 당첨이 취소될 수 <br/>있습니다.</p>
									</li>
									<li>꿈 명함 수령 후 반드시 <strong>후기 사진</strong>과 200자 이내의 소감을 <br/>보내주세요.</li>
									<li>꿈 명함은 <strong>재직학교로 배송</strong>됩니다.</li>
								</ul>
							</div>
						</div>
						...
						<div className="acco_notice_list pdside20 mt25">
							<div className="acco_notice_cont">
								<span className="privacyTit">개인정보 수집 및 이용동의</span>
								<ul className="privacyList">
									<li>이용 목적 : 상품 배송 및 고객 문의 응대</li>
									<li>수집하는 개인정보 : 성명, 휴대전화번호, 재직학교주소</li>
									<li>개인정보 보유 및 이용기간 : 2022년 캠페인 종료시까지<br/>
										(이용목적 달성 시 즉시 파기)</li>
									<li>선물 발송을 위해 개인정보(성명, 휴대전화번호, 재직학교주소)가<br/> 배송업체에 제공됩니다.<br/>
						...
						<button
							...
							className="btn_full_on mt35">참여하기
						</button>
					</div>
				</div>
			</section>
