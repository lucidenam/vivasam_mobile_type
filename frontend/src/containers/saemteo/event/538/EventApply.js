			...
			<section className="vivasamter">
				...
				<div className="applyDtl_top">
					<div className="applyDtl_cell ta_c pick">
						<h3><strong>57차 교사문화프로그램 신청하기</strong></h3>
					</div>
					<div className="applyDtl_cell ta_c pick">
						<p>
				...
				<div className="vivasamter_apply">
					<div className="vivasamter_applyDtl pdside0">
						<div className="pdside20 pb25">
							...
							<p className="evtForm_labelTxt mt10">* 동반자 선생님 신청은 최대 3명까지 가능합니다.</p>
							<p className="evtForm_labelTxt">* <span
								className="c_o">선생님 대상으로 하는 프로그램으로 선생님만 입장이 가능</span>합니다</p>
						</div>
						...
						<div className="checkbox_circle_box pdside20 acco_notice_list notice_sec">
							<div className="acco_notice_cont">
								...
								<label
									htmlFor="join_agree2"
									className="checkbox_circle_simple">
									<strong className="checkbox_circle_tit">행사 일정 및 장소
										<span className="c_o">(2025년 2월 22일 12시 ~ 13시 40분 <br/>/대학로 JTN 아트홀 3관)</span>를 확인하였습니다.
									</strong>
								</label>
							</div>
						</div>
