...
class EventApply extends Component {
	...
	componentDidMount() {
		...
		else if (!eventAnswer.answerNumber) {
	...
	insertApplyForm = async () => {
		...
		try {
			...
			if (response.data.code === '1') {
				...
				if(DD === "24") {
					common.error("오늘 준비한 선물이 모두 소진되어 이벤트가 종료되었습니다.");
				} else {
					common.error("오늘 준비한 선물이 모두 소진되어 이벤트가 종료되었습니다. \n내일 오후 4시에 다시 신청해주세요!");
				}
	...
	render() {
		...
		return (
			<section className="vivasamter event241118">
				<h2 className="blind">
					비바샘터 신청하기
				</h2>
				<div className="applyDtl_top">
					<div className="applyDtl_cell ta_c pick">
						<h3><strong>비바샘과 미리 그려보는 2025</strong> 신청하기</h3>
					</div>
				</div>
				<div className="vivasamter_apply">
					<div className="vivasamter_applyDtl pdside0">
						<div className="pdside20 pb25">
							...
							<h2 className="info_tit">
								<label htmlFor="ipt_receive">학교 주소</label>
							</h2>
							<div className="input_wrap">
								<input
									type="text"
							...
							<div
								...
								<div
									className={'input_wrap mt5 receiveGradeClass ' + (event.receive === '교실' ? '' : 'hide')}>
									<input
										type="text"
										maxLength={1}
										name="receiveGrade"
							...
							<div className="infoTxtWrap">
								...
								<p className="inputInfoTxt">* 비상교육 지사를 통해 순차적으로 발송됩니다.</p>
							</div>
						</div>
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList">
									...
									<li>개인정보 보유 및 이용기간 : 2024년 12월 31일까지</li>
									<li>연락처 및 주소 미기재, 오기재 시 경품 재발송이 불가능합니다. 입력하신 개인정보를 꼭 확인해 주세요.</li>
									<li>경품 발송을 위해 개인정보(성명, 휴대전화번호,주소)가 서비스사에 제공됩니다. <br/>(㈜CJ대한통운 사업자등록번호 : 110-81-05034)
									</li>
								</ul>
								<br/>
