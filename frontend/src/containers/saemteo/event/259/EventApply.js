...
class EventApply extends Component {
    ...
    componentDidMount(){
        ...
        if((eventId == null) ||  (typeof eventId == "undefined")){
            ...
            history.push('/saemteo/event/view/259');
        }else{
    ...
    validateInfo = () => {
        ...
        if(!event.userName){
            ...
            obj.message = "노트 신청 개수를 입력해주세요.";
        }else if(this.state.step2 === ""){
            obj.message = "노트 활용 계획을 입력해주세요.";
        }else{
            obj.result = true;
        }
        return obj;
                ...
                <div className="vivasamter_apply">
                    <div className="vivasamter_applyDtl">
	                    ...
	                    <h2 className="info_tit mt25 txt_ls">
                            <label htmlFor="applyContent">1. &lt;위인의 생각을 쓰다&gt; 노트 신청 개수</label>
                    </h2>
                    <div className="input_wrap">
                        <input
                                type="number"
                        ...
                        <h2 className="info_tit mt25 txt_ls">
                            <label htmlFor="applyContent2">2. &lt;위인의 생각을 쓰다&gt; 노트 활용 계획</label>
                        </h2>
	                    <div className="input_wrap">
	                        <textarea
	                            name="applyContent2"
