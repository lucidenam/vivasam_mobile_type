...
class EventApply extends Component {
	...
	validateInfo = () => {
		...
		} else if(event.giftList === '' || event.giftList === null) {
			obj.message = '선물을 선택해 주세요.';
		} else {
			obj.result = true;
		}
		return obj;
	...
	applyButtonClick = (target) => {
		...
		try {
			...
			event.eventAnswerDesc2 = eventAnswer.eventAnswerContent + "^||^" + event.giftList;
			SaemteoActions.pushValues({type: "event", object: event});
			// 신청 처리
			...
			<section className="vivasamter">
				...
				<div className="applyDtl_top">
					<div className="applyDtl_cell ta_c pick">
						<h3><strong>VISANG + 한해 6탄 비상한.줄</strong></h3>
					</div>
				</div>
				<div className="vivasamter_apply">
					<div className="vivasamter_applyDtl pdside0">
						<div className="pdside20 pb25">
							...
							<h2 className="info_tit">
								<label htmlFor="ipt_name">추천하신 책과 어울리는 선물을 골라 주세요.</label>
							</h2>
							<div className="input_wrap">
								<ul className="join_ipt_chk">
									<li className="join_chk_list">
										<input
											...
											onChange={this.handleChange}
										/>
										<label htmlFor="gift1">향기로운 커피</label>
									</li>
									<li className="join_chk_list">
										<input
											id="gift2"
											...
											onChange={this.handleChange}
										/>
										<label htmlFor="gift2">은은한 티</label>
									</li>
									<li className="join_chk_list">
										<input
											id="gift3"
											...
											onChange={this.handleChange}
										/>
										<label htmlFor="gift3">달콤한 스무디</label>
									</li>
								</ul>
							</div>
