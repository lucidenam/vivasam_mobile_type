...
class EventApply extends Component {
    ...
    componentDidMount = async() => {
        ...
        if (!eventAnswer || !eventAnswer.eventAnswerDesc || !eventAnswer.rdoChecked) {
    ...
    insertApplyForm = async () => {
        ...
        const rdoCheckedIdx = Number(eventAnswer.rdoChecked);
        try {
            let applyTargetContentCntArr = [];
            for (let i=3;i<=10;i++) {
                applyTargetContentCntArr.push((i === rdoCheckedIdx) ?  '1' : '0');
            }
            ...
            event.applyContentTotCnt = '8';     /* 상품 종류 수 */
            event.applyContentNumbers = '3,4,5,6,7,8,9,10';    /* 상품 seq, 복수신청시는 csv(3,4,5) */
            event.applyTargetContentCnt = applyTargetContentCntArr.join(',');  /* 상품 신청수량, 복수신청시는 csv(0,1,1) */
            ...
            <section className="vivasamter">
                ...
                <div className="applyDtl_top">
                    <div className="applyDtl_cell">
                        <h3><strong>광역 지도</strong> 세트 신청하기</h3>
                    </div>
                </div>
                    ...
                    <div className="vivasamter_applyDtl">
                        ...
                        <div className="acco_notice_list">
                            <div className="acco_notice_cont mt10">
                                <span className="acco_notice_tit info_tit pb10">광역 지도 세트 배송 관련</span>
                                <ul className="policy">
                                    <li className="bulTxt">광역 지도 세트는 선생님 재직 학교의 인근 비상교육 지사를 통해 전달할 예정입니다. 재직 학교를 정확히 확인해 주세요.</li>
                        ...
                        <div className="acco_notice_list">
                            <div className="acco_notice_cont mt10">
                                ...
                                <ul className="policy">
                                    <li className="bulTxt">이용목적 : 광역 지도 발송</li>
