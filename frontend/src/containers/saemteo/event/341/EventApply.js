...
class EventApply extends Component {
    ...
    componentDidMount = async() => {
        ...
        if (now < '202104161500') {
            common.info('이벤트는 오후 3시부터 신청가능합니다.');
    ...
    insertApplyForm = async () => {
        ...
        try {
            ...
            event.amountYn = 'Y';
            event.eventAnswerDesc2 = '1';
            event.applyContentTotCnt = '1';
            event.applyContentNumbers = '3';
            event.applyTargetContentCnt = '1';
            ...
            <section className="vivasamter">
                ...
                <div className="applyDtl_top">
                    <div className="applyDtl_cell">
                        <h3>한눈에 보는 한국사·세계사 <strong>역사 연표 브로마이드</strong></h3>
                    </div>
                </div>
                <div className="vivasamter_apply">
                    <div className="vivasamter_applyDtl">
                        ...
                        {(event.schName == '' && event.userInfo == 'Y') && <p className="mb10 point_red">* 학교가 등록되지 않았습니다. 학교검색에서 재직학교를 선택하세요.</p>}
                        {event.userInfo == 'Y' && <p className="mb25">* 학교 검색에서 찾으시는 학교가 없을 경우, 직접 입력을 통해 재직 학교명과 소재지를 입력해 주세요.</p>}
                        ...
                        <div className="acco_notice_list">
                            <div className="acco_notice_cont mt10">
                                ...
                                <ul className="policy">
                                    <li>- 이용목적 : 역사 연표 브로마이드 발송</li>
                                    <li>- 수집하는 개인정보 : 성명, 재직 학교, 학교 소재지, 수령처, 휴대전화번호</li>
                                    <li>- 개인정보 보유 및 이용기간 : 휴대전화번호는 2021년 4월 31일까지만 보유하며, 재직 학교와 학교 소재지의 정보는 비바샘 개인정보에 갱신됩니다.</li>
                                    <li>- 수집하는 개인정보의 취급위탁 : 브로마이드 발송을 위해 개인정보(이름/주소/연락처)를 배송업체에 취급 위탁<br />(㈜한진 사업자등록번호 : 201-81-02823)</li>
                                </ul>
