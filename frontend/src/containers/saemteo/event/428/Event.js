...
class Event extends Component {
    state = {
        ...
        evtComment: '',
        eventUrl: 'https://www.vivasam.com/event/2023/viewEvent428',
    }
    ...
    render() {
        ...
        return (
            <section className="event230125">
                <span className="teacherProgram">교사문화 프로그램 43차</span>
                <span className="evtCon"><em className="blind">이벤트 신청 시 비바콘 100콘 적립</em></span>
                <div className="evtCont01">
                    <h1><img src="/images/events/2023/event230125/evtCont1.png" alt="인생날" /></h1>
                    <div className="blind">
                        <div className="evtTit">
                            ...
                            <p>
                                오늘 하루 내가 영화 속 주인공 한 번쯤 꿈꿔보았을 영화 같은 하루
                            </p>
                            <p>
                                다가오는 새 학기를 앞두고 마지막 힐링이 필요한 선생님께 비바샘이 '인생 날'을 선물합니다.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="evtCont02">
                    <h1><img src="/images/events/2023/event230125/evtCont2.png" alt="인생날" /></h1>
                    <div className="blind">
                        <div className="evtPeriod">
                            <div className="blind">
                                <p>
                                    오직 선생님을 위한 힐링 문화프로그램
                                    편안한 영화관람부터 셰프의 코스 요리까지!
                                </p>
                                <ul>
                                    <li>품격있는 다이닝 홀</li>
                                    <li>프리미엄 코스 요리</li>
                                ...
                                <strong><span className="blind">신청 안내 x 당첨 꿀팁</span></strong>
                                <div>
                                    <span className="tit blind">신청 기간</span><span className="txt"><span
                                    className="blind">2023.1.27(금) ~ 2.12(일)</span></span>
                                </div>
                                <div>
                                    <span className="tit blind">당첨 발표</span><span className="txt"><span
                                    className="blind">2023.2.13(월)</span></span>
                                </div>
                                <div>
                                    <span className="tit blind">초대 인원</span><span className="txt"><span
                                    className="blind">46명</span></span>
                                    <span>(동료 선생님 1인 동반 신청 가능)</span>
                                </div>
                                <div>
                                    <span className="tit blind">참가비</span><span className="txt"><span
                                    className="blind">3천원+자율기부금</span></span>
                                    <span>
                                            참가비는 소외계층 교육을 위한 학생복지기금으로 전액 기부됩니다.
                                            자율기부금은 개인 선택사항입니다.
                                        </span>
                                </div>
                            </div>
                        ...
                        <div>
                            <span className="tit blind">인생날 당첨 꿀팁</span>
                            <ul>
                                <li>페이지 하단 기대 평 작성시, 당첨확률 UP</li>
                                <li>함께 하고 싶은 동료 선생님께 이벤트 공유하기</li>
                        ...
                        <div>
                            <div>
                                <p>인생날</p>
                                <div>
                                    <span className="tit blind">일시</span><span className="txt"><span className="blind">2023.2.18(토) 11시~15시</span></span>
                                </div>
                                <div>
                                    <span className="tit blind">장소</span><span className="txt"><span className="blind">CGV 씨네 드 쉐프 압구정</span></span>
                                </div>
                                <div>
                                    <span className="tit blind">내용</span>
                                    <ul>
                                        <li>최상의 편안함을 제공하는 시네마에서 영화 관람</li>
                                        <li>정상급 세프가 선보이는 코스요리 제공</li>
                                    </ul>
                                </div>
                            </div>
                            <div>
                                ...
                                <ul className="evtInfoList">
                                    <li>초대 인원만 참석하실 수 있으며, 다른 선생님께 당첨 기회를 양보하실 수 없습니다.</li>
                    ...
                    <a href="https://bit.ly/3G34CiT" target="_blank" className="btnMap"><span className="blind">약도보기</span></a>
