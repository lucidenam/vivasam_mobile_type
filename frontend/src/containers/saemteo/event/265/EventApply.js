...
class EventApply extends Component {
    ...
    componentDidMount(){
        ...
        if((eventId == null) ||  (typeof eventId == "undefined")){
            ...
            history.push('/saemteo/event/view/265');
        }else{
    ...
    validateInfo = () => {
        ...
        if(!event.userName){
            ...
            obj.message = "특별한 물건과 사연을 입력해주세요.";
        }else{
            obj.result = true;
        }
        return obj;
                    ...
                    <div className="vivasamter_applyDtl">
						...
						<div className="group">
							<h2 className="info_tit txt_ls">
	                    	    <label for="applyContent2" className="bl">2019년 우리 반을 추억할 수 있는 특별한 물건과 사연을 남겨주세요.</label>
	                    	</h2>
