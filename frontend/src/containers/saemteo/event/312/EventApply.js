...
class EventApply extends Component {
    ...
    applyButtonClick = (target) => {
        ...
        try {
            ...
            event.eventAnswerDesc = event.inputType + '/' +event.schName + '/' +event.cellphone + '/' +event.schZipCd + '/' +event.schAddr + ' ' +event.addressDetail + '/수령처 : ' + receive + '/신청사유 : '+eventAnswer.eventAnswerContent.applyContent;
            SaemteoActions.pushValues({type:"event", object:event});
            // 신청 처리
            ...
            <section className="vivasamter">
                ...
                <div className="vivasamter_apply">
                    <div className="vivasamter_applyDtl">
                        ...
                        <h2 className="info_tit">
                            <label htmlFor="ipt_name">학교정보</label>
                        </h2>
                        ...
                        <p className="mt10 mb25 c_gray">※ 학교로만 배송 가능합니다.<br />
                            <span>학교 소재지 및 수령처는 수정이 불가능하니 정확히 기입해 주세요.</span>
                        </p>
                        <h2 className="info_tit">
                        ...
                        <div className="acco_notice_list">
                            ...
                            <div className="acco_notice_cont mt10">
                                <ul class="policy">
                                    ...
                                    <li>•수집하는 개인정보의 처리위탁 : 교재 배송을 위해 개인정보를 발송업체에 취급 위탁(㈜한진 사업자등록번호:201-81-02823)</li>
                                </ul>
                            </div>
                            ...
                            <div className="checkbox_circle_box mt5">
                                ...
                                <label
                                    ...
                                    className="checkbox_circle_simple">
                                    <strong className="checkbox_circle_tit">
                                        재직 학교 및 학교 소재지 정보를 정확하게 기입하였음을 확인합니다.
                                    </strong>
                                </label>
                            </div>
