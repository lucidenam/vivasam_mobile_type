...
class EventApply extends Component {
	...
	getEventInfo = async (eventId) => {
		...
		if (response.data.code && response.data.code === "0") {
			...
			event.subjectMid = ["국어", "영어", "수학", "사회", "역사", "도덕", "과학", "한문", "기술가정", "정보", "음악", "미술", "체육", "진로와 직업"];
			event.subjectHigh = ["국어", "영어", "수학", "사회", "역사", "윤리", "과학", "한문", "기술가정", "정보", "음악", "미술", "체육", "진로와 직업"];
			//event.subjectHigh = ["국어", "영어", "수학", "사회", "역사", "윤리", "과학", "한문", "기술가정", "정보", "음악", "미술", "체육", "진로와 직업", "확률과 통계", "기하", "통합과학", "과학탐구실험", "물리학", "화학", "생명과학", "지구과학", "통합사회", "한국사", "생활과 윤리", "윤리와 사상", "사회문화", "경제", "한국지리", "동아시아사", "세계지리", "세계사", "정치와 법", "기술가정", "한문", "정보", "진로와 직업", "음악", "인공기능 기초"];
						...
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList">
									<li>이용목적 : 신학기 연구용 자료 전달</li>
									<li className="infoIndent">
										수집하는 개인정보 : 성명, 휴대전화번호, 재직 학교, 담당 학년, 신청 교과, 비상교과서 채택 여부
									</li>
									<li>
										개인정보 보유 및 이용기간 : 2025년 4월 30일까지 <br />
										{/*(이용목적 달성 시 즉시 파기)*/}
									</li>
								</ul>
								<br />
								<p className="privacyTxt">
									선생님께서 개인정보의 수집 및 이용에 대한 동의를 거부할 수 있습니다.<br />
