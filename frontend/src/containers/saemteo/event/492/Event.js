...
class Event extends Component {
    ...
    render() {
        ...
        return (
            <section className="event240403">
                <div className="evtCont01">
                    {/*<span className="evtCon"><em className="blind">이벤트 신청 시 비바콘 100콘 적립</em></span>*/}
                    <div className="evtTit">
                        <img src="/images/events/2024/event240403/evtTit.png" />
                        <div className="blind">
                            <h2>
                                <span>2024 비바샘꿈지기 캠페인</span>
                                꿈 명함 만들기 프로젝트
                            </h2>
                            <p>
                            ...
                            <div>
                                <p>꿈 명함 제작 일정</p>
                                <p>※ 당첨자 발표부터 꿈 명함 수령까지 약 1개월 정도 소요 됩니다.​​</p>
                                <ul>
                                    <li>
                                        당첨 안내
                                        <span>1주</span>
                        ...
                        <div className="btnWarp">
                            <button className="btnApply" onClick={this.eventApply}>
                                <img src="/images/events/2024/event240403/btn_apply.png"  />
