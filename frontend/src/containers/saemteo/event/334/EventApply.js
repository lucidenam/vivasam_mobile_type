...
class EventApply extends Component {
    ...
    componentDidMount = async() => {
        ...
        const {applyName, applyContent} = eventAnswer;
        
        // 응답 문항이 NULL이거나 undefined인 경우 이전페이지로 돌려야함
        if((eventId == null) || (typeof eventId == "undefined") || !applyName || !applyContent){
    ...
    insertApplyForm = async () => {
        ...
        try {
            ...
            event.amountYn = 'N';
            event.eventAnswerDesc2 = eventAnswer.applyName + '^||^' + eventAnswer.applyContent;
                ...
                <div className="vivasamter_apply">
                    <div className="vivasamter_applyDtl">
                        ...
                        <div className="acco_notice_list">
                            <div className="acco_notice_cont mt10">
                                ...
                                <ul className="policy">
                                    ...
                                    <li>- 개인정보 보유 및 이용기간 : 2021년 4 월 31일까지<br />(이용목적 달성 시 즉시 파기)</li>
                        ...
                        <button
                            ...
                            className="btn_full_on mt35">참여하기</button>
                    </div>
                </div>
            </section>
