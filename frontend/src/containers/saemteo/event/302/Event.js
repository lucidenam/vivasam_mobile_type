...
class Event extends Component{
    ...
    setApplyContent1 = (e) => {
        if(e.target.value.length > 100){
            ...
            this.setState({
                contentLength1: e.target.value.length,
                applyContent1: e.target.value
            });
        }
    ...
    setApplyContent2 = (e) => {
        if(e.target.value.length > 200){
            ...
            this.setState({
                contentLength2: e.target.value.length,
                applyContent2: e.target.value
            });
        }
        ...
        if(!logged){ // 미로그인시
            ...
            try {
                ...
                if(response.data.code === '3'){
                    ...
                    if(this.state.applyContent1 == null || this.state.applyContent1 == 'undefined' || this.state.applyContent1 == ''){
                        common.info("선생님이 좋아하는 역사 속 디자인 작품을 꼽아주세요.");
                        return;
                    }
                    if(this.state.applyContent2 == null || this.state.applyContent2 == 'undefined' || this.state.applyContent2 == ''){
                        common.info("선생님만의 감상 팁을 남겨주세요.");
                        return;
                    }
                    let eventAnswerArray = {};
                    eventAnswerArray.Q1 = this.state.applyContent1;
                    eventAnswerArray.Q2 = this.state.applyContent2;
    ...
    render () {
        return (
            <section className="event200616">
                <h1><img src="/images/events/2020/event200616/mobile_img01.jpg" alt="역사, 디자인을 품다"/></h1>
                <div className="blind">
                    선생님과 함게 만드는 역사의 힘 6탄
                    <p>옛 풍경이 담긴 그림 한 점, 세계적인 건축물, 사연 있는 문장 한 줄, 박물관에서 우연히 마주친 도자기까지 역사 속엔 그 시대의 디자인도 함께 담겨 있습니다.<br/>
                        선생님이 가장 좋아하시는 디자인 작품은 무엇인가요?<br/>
                        선생님만의 감상 팁도 함께 들려주세요.
                    </p>
                    <dl>
                        <dt>참여 기간</dt>
                        <dd>2020.06.17~07.07</dd>
                        <dt>당첨자 발표</dt>
                        <dd>2020.07.09</dd>
                        <dt>당첨 선물</dt>
                        <dd>고급 미술도구세트(5명), 핸디 선풍기(50명), 배스킨라빈스 아이스크림(20명)</dd>
                    </dl>
                </div>

                <div class="steps">
                    <p><img src="/images/events/2020/event200616/txt.jpg" alt="STEP1, 선생님이 좋아하는 역사 속 디자인 작품을 꼽아주세요."/></p>
                    <div className="input_wrap">
                            <textarea
                                ...
                                rows="5"
                                maxLength="101"
                                value={this.state.applyContent1}
                                onChange={this.setApplyContent1}
                                placeholder="100자 까지 입력하실 수 있습니다."
                                className="textarea">
                            </textarea>
                        <div className="count_wrap">
                            <p className="count">(<span>{this.state.contentLength1}</span>/100)</p>
                        </div>
                    </div>

                    <p><img src="/images/events/2020/event200616/txt2.jpg" alt="STEP2, 선생님만의 감상 팁을 남겨주세요."/></p>
                    <div className="input_wrap">
                            <textarea
                                name="applyContent2"
                                id="applyContent2"
                                ...
                                rows="10"
                                maxLength="201"
                                value={this.state.applyContent2}
                                onChange={this.setApplyContent2}
                                placeholder="200자 까지 입력하실 수 있습니다."
                                className="textarea">
                            </textarea>
                        <div className="count_wrap">
                            <p className="count">(<span>{this.state.contentLength2}</span>/200)</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="btn_wrap">
                    <button type="button" id="eApply" className="btn_apply" onClick={this.eventApply}><img
                        src="/images/events/2020/event200616/btn_apply.jpg" alt="이벤트 참여하기"/></button>
                </div>
                ...
                <div className="cont comment_wrap">
                    ...
                    <button className="btn_more"  style={{ visibility : this.state.eventViewAddButton == 1 ? 'visible' : 'hidden' }} onClick={this.commentListAddAction}>
                        <img
                        src="/images/events/2020/event200616/btn_more.jpg" alt="더보기"/>
                    </button>
                </div>
            </section>
        )
...
class EventListApply extends Component{
    ...
    render(){
        return (
            <li>
                <div className="tit">
                    <span>역사속 디자인 작품</span>
                    <strong dangerouslySetInnerHTML = {{__html: this.state.eventContents1}}></strong>
                </div>
                 <p className="comment" dangerouslySetInnerHTML = {{__html: this.state.eventContents2}}></p>
