...
class EventApply extends Component {
    ...
    componentDidMount(){
        ...
        if((eventAnswer.eventAnswerContent.Q1 == null) || (typeof eventAnswer.eventAnswerContent.Q1 == "undefined")
            || (eventAnswer.eventAnswerContent.Q2 == null) || (typeof eventAnswer.eventAnswerContent.Q2 == "undefined")
            || (eventId == null) ||  (typeof eventId == "undefined")){
            common.error("역사 속 디자인 작품 과 감상팁을 남겨주세요.");
            history.push('/saemteo/event/view/'+eventId);
        }else{
            this.state.applyContent1 = eventAnswer.eventAnswerContent.Q1;
            this.state.applyContent2 = eventAnswer.eventAnswerContent.Q2;
    ...
    applyButtonClick = (target) => {
        ...
        try {
            ...
            +'/ 1. 역사속 디자인 작품 : '+this.state.applyContent1+' , 2. 감상 팁 : '+this.state.applyContent2;
            SaemteoActions.pushValues({type:"event", object:event});
    ...
    insertApplyForm = async () => {
        ...
        try {
            ...
            if(response.data.code === '1'){
                ...
                event.eventAnswerDesc = this.state.applyContent1 + '^||^' + this.state.applyContent2; // 내용
            ...
            <section className="vivasamter">
                ...
                <div className="applyDtl_top">
                    <div className="applyDtl_cell">
                        <h3>선생님과 함께 만드는 <em>역사의 힘 6탄</em></h3>
                    </div>
                </div>
                    ...
                    <div className="vivasamter_applyDtl">
                        ...
                        <div className="acco_notice_list">
                            ...
                            <div className="acco_notice_cont mt10">
                                <ul className="policy">
                                    <li>이용목적 : 자료집 발송</li>
                                    <li>수집하는 개인정보 : 성명, 학교명, 학교 주소, 휴대전화 번호</li>
                                    <li>개인정보 보유 및 이용 기간 : 이용목적 달성 시 즉시 파기</li>
                                    <li>선물 발송을 위해 개인정보(성명/재직 학교/휴대전화 번호)가 배송업체에 제공됩니다.<br/>
                        ...
                        <button onClick={this.applyButtonClickSafe} className="btn_full_on mt35">신청하기</button>
                    </div>
                </div>
            </section>
