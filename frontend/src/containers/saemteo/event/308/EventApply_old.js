...
class EventApply extends Component {
    ...
    validateInfo = () => {
        ...
        if(!event.userName){
            ...
            obj.message = '휴대전화번호를 입력해주세요.';
        } else if(event.applyCnt == 0 || event.applyCnt.trim() == ''){
            obj.message = '신청수량을 입력해주세요.';
        }else if(!event.agree){
    ...
    applyButtonClick = (target) => {
        ...
        try {
            ...
            event.eventAnswerDesc = event.inputType + '/' +event.schName + '/' +event.cellphone + '/' +event.schZipCd + '/' +event.schAddr + ' ' +event.addressDetail + '/수령처 : '+receive +'/신청수량 : '+event.applyCnt;
            ...
            <section className="vivasamter">
                ...
                <div className="applyDtl_top">
                    <div className="applyDtl_cell">
	                    <h3>위인의 뜻을 되새기는 <em>필사 한 줄</em> 참여하기</h3>
                    </div>
                </div>
                <div className="vivasamter_apply">
                    <div className="vivasamter_applyDtl">
                        ...
                        <h2 className="info_tit">
                            <label htmlFor="ipt_phone">신청수량</label>
                        </h2>
                        <div className="input_wrap mb25">
                            <input
                                type="number"
                                id="ipt_num"
                                name="applyCnt"
                                onChange={this.setApplyCnt}
                                value={event.applyCnt}
                                maxLength="2"
                                className="input_sm mb25" />

                            <span><i>권</i> ※ 최대 30권 신청 가능</span>
                            <ul className="mt20">
                                <li>* 1인 최대 30권까지 신청하실 수 있습니다.</li>
                        ...
                        <div className="acco_notice_list">
                            ...
                            <div className="acco_notice_cont mt10">
                                <ul class="policy">
                                    ...
                                    <li>- 개인정보 보유 및 이용기간 : 2020년 9월 30일까지 (이용목적 달성 시 즉시 파기)</li>
