...
class EventApply extends Component {
    ...
    componentDidMount(){
        ...
        if((eventAnswer.eventAnswerContent.Q1 == null) || (typeof eventAnswer.eventAnswerContent.Q1 == "undefined")
            ...
            history.push('/saemteo/event/view/286');
        }else{
                        ...
                        <div className="acco_notice_list">
                            ...
                            <div className="acco_notice_cont mt10">
                                <ul class="policy">
	                                ...
	                                <li>- 개인정보 보유 및 이용기간 : 2020년 4월 3일까지 (이용목적 달성 시 즉시 파기)</li>
	                                <li>- 수집하는 개인정보의 취급위탁 : 수집하는 개인정보의 취급위탁 : 자료집 발송을 위해 개인정보(이름/주소/연락처)를 배송업체에 취급 위탁<br />(㈜한진 사업자등록번호 : 201-81-02823)</li>
                                </ul>
