...
class EventApply extends Component {
  ...
  applyButtonClick = (target) => {
    ...
    receiveInfo = userInfo + '/' + event.schName + '/' + event.schZipCd + '/' + event.schAddr + ' ' + event.addressDetail + '/' + event.cellphone + '/수령처 : ' + receive;
  ...
  insertApplyForm = async () => {
    ...
    try {
      ...
      var params = {
        ...
        eventAnswerDesc2: eventAnswer.eduCnt + '^||^' + eventAnswer.eduArr + '^||^' + event.eventAnswerDesc2,
            ...
            <div className="vivasamter_applyDtl pdside0 type02">
              <div className="applyDtl_inner pdside20 pt25 pb25">
                ...
                <h2 className="info_tit not_essential">
                  <label htmlFor="ipt_textarea">[비바샘 에듀테크의 달 이벤트] 체험 소감</label>
                </h2>
                <div className="input_wrap">
												<textarea
                          name="applyContent"
              ...
              <div className="acco_notice_list pdside20">
                <div className="acco_notice_cont">
                  ...
                  <ul className="privacyList">
                    ...
                    <li>개인정보 보유 및 이용기간 : 2025년 6월 30일까지 (이용목적 달성 시 즉시 파기)</li>
                    <li>연락처 오류 시 경품 재발송이 불가능합니다. 개인정보를 꼭 확인해 주세요.</li>
                    <li>경품 발송을 위해 개인정보(성명, 휴대전화번호, 주소)가 서비스사에 제공됩니다.<br/>(㈜카카오 사업자등록번호 : 120-81-47521)/(㈜모바일이앤엠애드 사업자등록번호:215-87-19169) (CJ대한통운(주) 사업자등록번호 : 110-81-05034)</li>
                  </ul>
                </div>
              </div>
