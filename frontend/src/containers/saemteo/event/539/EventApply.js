...
class EventApply extends Component {
	...
	validateInfo = () => {
		...
		if (!event.schName) {
			...
			obj.message = '휴대전화번호를 입력해 주세요.';
		} else if (eventAnswer.eventId == 540 && !event.agree1) {
			obj.message = '필수 동의 선택 후 이벤트 신청을 완료해 주세요.';
		} else if (eventAnswer.eventId == 541 && !event.agree2) {
			obj.message = '필수 동의 선택 후 이벤트 신청을 완료해 주세요.';
		} else {
			obj.result = true;
		}
			...
			<section className="vivasamter">
				{
					eventAnswer.eventId === 540
						...
						<Fragment>
							...
							<div className="applyDtl_top ">
								<div className="applyDtl_cell ta_c pick">
									<h3>
										<strong>1) </strong>NEW 비바샘 퀴즈 풀기 이벤트
									</h3>
								</div>
							</div>
									...
									<div className="acco_notice_list pdside20 mt0">
										<div className="acco_notice_cont">
											...
											<ul className="privacyList type02 ">
												...
												<li>개인정보 보유 및 이용 기간: 2025년 3월 31일까지(이용목적 달성 시 즉시 파기)</li>
												<li>개인정보 오기재로 인한 경품 재발송은 불가능합니다. 개인정보를 꼭 확인해 주세요.</li>
												<li>경품 발송을 위한 개인정보(성함, 휴대 전화번호, 주소)가 기프티콘 발송 서비스사에 제공됩니다. <br/>(㈜카카오 사업자등록번호 : 120-81-47521) <br/>(㈜모바일이앤엠애드 사업자등록번호:215-87-19169)</li>
											</ul>
											<br />
						...
						<Fragment>
							...
							<div className="applyDtl_top ">
								<h3>
									<strong>2) </strong> NEW 비바샘 BI 찾기 이벤트
								</h3>
							</div>
							<div className="vivasamter_apply ">
								<div className="vivasamter_applyDtl type02 pdside0">
									...
									<div className="acco_notice_list pdside20 mt0">
										<div className="acco_notice_cont">
											...
											<ul className="privacyList type02 ">
												...
												<li>개인정보 보유 및 이용 기간: 2025년 3월 31일까지(이용목적 달성 시 즉시 파기)</li>
												<li>개인정보 오기재로 인한 경품 재발송은 불가능합니다. 개인정보를 꼭 확인해 주세요.</li>
												<li>경품 발송을 위한 개인정보(성함, 휴대 전화번호, 주소)가 기프티콘 발송 서비스사에 제공됩니다. <br/>(㈜카카오 사업자등록번호 : 120-81-47521) <br/>(㈜모바일이앤엠애드 사업자등록번호:215-87-19169)
												</li>
											</ul>
											<br/>
