...
class EventApply extends Component {
	...
	applyButtonClick = (target) => {
		...
		try {
			...
			event.eventAnswerDesc2 = event.charNum;
			SaemteoActions.pushValues({type: "event", object: event});
			// 신청 처리
			...
			<section className="vivasamter">
				...
				<div className="applyDtl_top top_yell">
					<div className="applyDtl_cell ta_c pick">
						<h3><strong>VISANG+한해 8탄 비상한.트리</strong></h3>
					</div>
				</div>
						...
						<div className="acco_notice_list pdside20 ">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList event2">
									...
									<li>개인정보 보유 및 이용기간 : 2023년 1월 31일까지<br /> (이용목적 달성 시 즉시 파기)</li>
									<li>개인정보 오류 또는 유효기간이 지난 상품은 재발송해 드리지 않습니다. 개인정보를 꼭 확인해 주세요.</li>
									<li>
										선물 발송을 위해 개인정보(성명, 휴대전화번호)가<br />
										서비스사에 제공됩니다.<br />
										(㈜카카오 사업자등록번호 120-81-47521),<br /> (주)모바일이앤엠애드 사업자등록번호 215-87-19169)
									</li>
								</ul>
								<br />
