...
class Event extends Component{
	...
	render() {
		return (
			<section className="event211209">
				<div className="evtCont01">
                    <h1><img src="/images/events/2021/event211209/img01.png" alt="제 6회 비상교육 창의 융합 수업 자료 공모전" /></h1>
                    <div className="evtNoti">
                        <p className="txt">2021년 한 해 동안 선생님께서 직접 만들고 활용하셨던<br />창의 융합 수업 자료를 기다립니다.</p>
                        <ul className="evtPeriod">
                            <li><span className="tit">참여 기간</span><span className="txt">2021.12.09(목) ~ 2022.01.25(화)</span></li>
                            <li><span className="tit">당첨자 발표</span><span className="txt">2022.02.22(화)</span></li>
                        </ul>
                    </div>
					{
						this.state.eventMode === 1 && (
							<span className="bannerFlo"><em className="blind">Early Bird Event. 12월 중 출품하시는 모든 분께 스타벅스 달콤한 디저트 세트를 드립니다! 매주 목요일 발송</em></span>
						)
					}
				</div>
				<div className="evtCont02">
					<h2><img src="/images/events/2021/event211209/img02.png" alt="공모 내용"/></h2>
					<div className="blind">
                        <ul>
                            <li>
                                <strong>공모 주제</strong>
                            ...
                            <li>
                                <strong>출품 내용</strong>
                                <ul>
                                    <li> 초 · 중 · 고 학교에서 실제 활용된 <span>비상교과서 수업 자료</span></li>
                                    <li>
                                        2차시 이상의 수업이 가능한 자료
                                        <ul>
                            ...
                            <li>
                                ...
                                <ul>
                                    ...
                                    <li>수업 계획안은 반드시 하단의 ‘참여하기’버튼을 통해 등록 해주세요.</li>
                                    <li>
                                        300MB 이상의 수업 자료는 이메일로 접수할 수 있습니다.<br />
                                        visangcontest@naver.com
                                    </li>
                                </ul>
                                <p>※ 이메일 제출 시, 제목을 설정해 주세요. [창의 융합 수업 자료 공모전_성명]</p>
                                <p>※ 이메일 제출시에도 반드시  하단의 ‘참여하기’ 를 통해 ‘수업계획안’을 등록해주세요. <br />(홈페이지 미 접수 시 정상 참여가 어렵습니다.)</p>
                            </li>
                        </ul>
					</div>
				...
				<div className="evtCont03">
					<h2><img src="/images/events/2021/event211209/img03.png" alt="시상 내역"/></h2>
					<div className="blind">
						<ul>
				...
				<div className="evtCont04">
					<h2><img src="/images/events/2021/event211209/img04.png" alt="심사 기준"/></h2>
					<div className="blind">
						<ul>
                ...
                <div className="evtCont05">
					<h2><img src="/images/events/2021/event211209/img05.png" alt="당선 확률을 높이는 3가지 꿀팁!"/></h2>
					<div className="blind">
						<ul>
					...
					<p className="evtNotiTxt">※ 본 공모전은 비바샘 PC 웹페이지에서 응모 가능합니다.</p>
				</div>
				<div className="evtCont06">
					<strong className="subTit">유의사항</strong>
                    <ul>
                        <li>제출하신 자료는 반환되지 않습니다.</li>
                        <li>수상작에 대한 저작재산권 전부 및 2차적 저작물 작성권, 편집 저작물<br />작성권은 ㈜비상교육에 양도됩니다.<br /><strong>※ 수상작으로 선정되신 후에도 선생님께서 제출하신 자료를<br />수업용/강의용으로 언제든 활용하실 수 있습니다.</strong></li>
                        <li>비상교육에서 수상작을 편집 및 가공하여 사용하거나 자료집으로<br />제작할 시 선생님과의 협의 하에 진행되며, 전체 차시에 대한 세부<br />자료와 사진 사용에 대한 초상권 동의서 등을 요청 드릴 수 있습니다.</li>
                        <li>당첨자에게는 공지사항 발표 후 개별 연락을 드립니다. 연락처를<br />확인해 주세요</li>
                        <li>대상, 최우수상, 우수상 상금은 제세공과금(4.4%)를 제외하고<br />지급합니다.</li>
                    </ul>
				</div>
			</section>
		);
