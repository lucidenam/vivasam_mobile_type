...
class Event extends Component {
    state = {
        ...
        evtComment: '',
        eventUrl: 'https://mv.vivasam.com/#/saemteo/event/view/579',
        replyAnswer: "", // 댓글 내용
    ...
    render() {
        ...
        return (
            <section className="event250804">
                {/*<span className="teacherProgram">교사문화 프로그램 61차</span>*/}
                <div className="evtCont1">
                    <h1><img src="/images/events/2025/event250804/evt_tit.png" alt="인생날 시즌6" /></h1>
                    <div className="blind">
                        <div className="evtTit">
                            <h2>
                                인생 날 시즌 6 비바샘과 함께하는 뽀송한 하루
                            </h2>
                            <p>
                                덥고 습한 여름, 지치진 않으셨나요?
                            </p>
                            <p>
                                선생님만을 위해 준비된 뮤지컬 공연! 동료 선생님과 함께하세요
                                힘차게 2학기를 시작할 수 있도록 뽀송한 하루를 만들어 드릴게요!
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="evtCont2">
                    <h1><img src="/images/events/2025/event250804/evt_cont.png" alt="인생날 시즌6"/></h1>
                    <div className="blind">
                            ...
                            <div>
                                <div>
                                    <div>
                                        ...
                                        className="blind">2025년 8월 4일 (월) ~ 8월 17일 (일)</span></span>
                                    </div>
                                    <div>
                                        <span className="tit blind">당첨자 발표</span><span className="txt"><span
                                        className="blind">8월 18일 (월)</span></span>
                                    </div>
                                    <div>
                                        <span className="tit blind">신청 기간</span>
                                        <span className="txt blind">180명 (동료 선생님 동반 신청 가능)</span>
                                    </div>
                                </div>
                                <ul>
                                    <li>
                        ...
                        <div>
                            ...
                            <div>
                                <div>
                                    ...
                                    className="blind">2025년 8월 23일 (토) 오후 10시 30분 ~ 12시 10분</span></span>
                                </div>
                                <div>
                                    <span className="tit blind">장소</span><span className="txt"><span
                                    className="blind">후암씨어터 (혜화역 인근)</span></span>
                                </div>
                                <div>
                        ...
                        <div>
                            <strong><span className="blind">공연 소개</span></strong>
                            <div className="blind">
                                <h3>뮤지컬 '연남동 빙굴빙굴 빨래방' 시놉시스</h3>
                            </div>
                            <div className="blind">
                                <p>
                                    반려견 진돌이와 살고 있는 할아버지 장영감
                                    성형외과 의사이자 기러기 아빠 대주
                                    보일러 수리공 남편의 아내이자 딸을 육아하고 있는 미라
                                    드라마 보조작가로 힘든 일상을 버티고 여름
                                    버스킹을 하며 가수의 꿈을 키우고 있는 하준
                                    행복한 일상이 한순간에 불행한 일상이 되어버린 대학생 연우

                                    언젠가부터 '빙굴빙굴 빨래방'을 찾는 손님들은
                                    테이블에 놓인 다이어리를 통해 각각의 고민을 털어놓고
                                    위로를 받는다.
                                    빙굴빙굴 빨래방의 비밀 노트에는 마음을 털어놓는
                                    힘이 있다.
                                    누군가가 고민을 적으면 누군가는 그 아래에 진심을
                                    담아 위로의 글을 담아내며 서로를 보듬어주게 되는데...
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="winTip">
                    <img src="/images/events/2025/event250804/evt_cont2.png" alt="당첨 꿀팁"/>
                    <div>
