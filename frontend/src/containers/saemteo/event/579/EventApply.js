			...
			<section className="vivasamter">
				...
				<div className="applyDtl_top">
					<div className="applyDtl_cell ta_c pick">
						<h3><strong>61차 교사문화프로그램 신청하기</strong></h3>
					</div>
					<div className="applyDtl_cell ta_c pick">
						<p>
				...
				<div className="vivasamter_apply">
					<div className="vivasamter_applyDtl pdside0">
						<div className="pdside20 pb25">
							...
							<p className="evtForm_labelTxt mt10">* 선생님을 대상으로 하는 프로그램으로, 학교 선생님만 동반참여<br/>하실 수 있습니다.</p>
							<p className="evtForm_labelTxt">* 동반 선생님은 최대 <span className="c_o">3인</span>까지 신청하실 수 있습니다.</p>
						</div>
						...
						<div className="acco_notice_list pdside20 notice_sec mt0">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList event2">
									...
									<li>개인정보 보유 및 이용기간 : 2025년 12월 31일까지(이용목적 달성 시 즉시 파기)</li>
								</ul>
						...
						<div className="checkbox_circle_box pdside20 acco_notice_list notice_sec">
							<div className="acco_notice_cont">
								...
								<label
									htmlFor="join_agree2"
									className="checkbox_circle_simple">
									<strong className="checkbox_circle_tit">프로그램 일정 및 장소 <span className="c_o">(8월 23일 10시 30분 ~ <br/>12시 10분 / 대학로 후암씨어터)</span> 를 확인하였습니다.
									</strong>
								</label>
							</div>
						</div>
