...
class EventApply extends Component {
    ...
    applyButtonClick = (target) => {
        ...
        try {
            ...
            event.eventAnswerDesc2 = eventAnswer.answer1 + '^||^' + eventAnswer.answer2;
            SaemteoActions.pushValues({type:"event", object:event});
            // 신청 처리
                    ...
                    <div className="vivasamter_applyDtl">
                        ...
                        <div className="acco_notice_list">
                            <div className="acco_notice_cont mt10">
                                ...
                                <ul className="policy">
                                    <li className="bulTxt">이용목적 : 경품 배송 및 고객문의 응대</li>
                                    <li className="bulTxt">수집하는 개인정보 : 성명, 재직 학교, 학교 소재지, 수령처, 휴대전화번호</li>
                                    <li className="bulTxt">개인정보 보유 및 이용기간 : 2021년 8월 31일까지 (이용목적 달성 시 즉시 파기)</li>
                                    <li className="bulTxt">주소 및 연락처 기재 오류로 반송된 선물은 재발송되지 않습니다. 개인 정보를 꼭 확인해주세요.</li>
                                    <li className="bulTxt">선물 발송을 위해 개인정보(성명/주소/연락처)가 배송업체에 제공됩니다.<br />(㈜한진 사업자등록번호 201-81-02823, (주)다우기술 사업자등록번호 220-81-02810)</li>
                                </ul>
