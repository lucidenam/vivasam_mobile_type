...
class EventApply extends Component {
    ...
    componentDidMount(){
        ...
        if((eventId == null) || (typeof eventId == "undefined")){
            ...
            history.push('/saemteo/event/view/268');
        }else{
    ...
    commentConstructorList = async() => {
        ...
        answerPage.pageNo = 1;
        answerPage.pageSize = 1;
        event.eventId = '270'; // 이벤트 ID
        ...
        this.setState({
            eventAnswerContents : JSON.stringify(responsedata[0].event_answer_desc)
        });
    ...
    insertApplyForm = async () => {
        ...
        try {
            ...
            if(response.data.code === '1'){
                ...
                PopupActions.openPopup({title:"신청완료", componet:<EventApplyResult eventId={'268'} surveyList={response.data.surveyList} handleClose={this.handleClose}/>});
            }else{
                    ...
                    <div className="vivasamter_applyDtl">
                        ...
                        <div className="input_wrap">
							<textarea
                                ...
                                placeholder={"* 동료 선생님이 남긴 단어에 이어 끝말잇기를 해주세요.\n┖ 동료 선생님이 남긴 단어 : "  + this.state.eventAnswerContents.replace(/(\\n|\\r\\n)/gi, ' ')}
                                className="textarea">
							</textarea>
