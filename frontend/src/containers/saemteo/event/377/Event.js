...
class Event extends Component{
    ...
    state = {
        isEventApply: false,
        rdoData: [
            {id: 1, labelTxt: '완자 VOCA PICK – 고등 필수', value:'고등 필수'},
            {id: 2, labelTxt: '완자 VOCA PICK – 수능 기출', value:'수능 기출'},
            {id: 3, labelTxt: '완자 VOCA PICK – 수능 고난도', value:'수능 고난도'},
        ],
    ...
    eventApply = async () => {
        ...
        if (loginInfo.schoolLvlCd !== 'HS') {
            common.info("고등학교 선생님 대상 이벤트 입니다.");
            return false;
        }
        ...
        try {
            ...
            if (rdoChecked < 0) {
                common.info('<완자 VOCA PICK> 교재를 선택해 주세요.');
                return;
            }
            
            if (comment.length < 10 || comment.length > 300) {
                common.info('교재 신청 이유를 10자 이상 300자 이내로 작성해 주세요.');
                return;
            }
            const eventAnswer = {
    ...
    render () {
        ...
        return (
			<section className="event211007">
                <div className="evtCont01">
                    <h1><img src="/images/events/2021/event211007/img01.png" alt="비상교육 신간 교재. VOCA PICK 체험 이벤트" /></h1>
                    <div className="evtNoti">
                        <p className="txt">기출에 나오는 핵심 단어만 pick하다!<br />비상교육 <strong>&lt;완자 VOCA PICK&gt; 연구용 교재</strong>를 체험해 보세요.</p>
						<p className="txt">추첨을 통해 총 100분께 완자 VOCA PICK 교재 1권을 보내드립니다.</p>
                        <ul className="evtPeriod">
                            <li><span className="tit">신청 기간</span><span className="txt">2021.10.07(목) ~ 10.12(화)</span></li>
                            <li><span className="tit">당첨 발표</span><span className="txt">2021.10.18(월)</span></li>
                            <li><span className="tit">교재 배송</span><span className="txt">~ 2021.10.22(금)</span></li>
                            <li><span className="tit">당첨 선물</span><span className="txt blind">추첨 100명. 고등 필수(연구용 교재), 수능 기출(연구용 교재), 수능 고난도(연구용 교재) 3종 중 택1 + 설문 응답자 50명. 스타벅스 아메리카노 Tall + 설문 우수자 3명. BHC 뿌링클 치킨</span></li>
                        </ul>
                    </div>
                </div>
                <div className="evtCont02">
                    <div className="imgWrap"><img src="/images/events/2021/event211007/img02.png" alt="이벤트 진행 단계" /></div>
                    <div className="evtStep">
                        <ol>
                            <li>당첨 문자 확인<br /><strong>(10.18)</strong></li>
                            <li>교재수령<br /><strong>(~10.22)</strong></li>
                            <li>교재 체험<br /><strong>(10.22~)</strong></li>
                            <li>설문조사<br />참여<br /><strong>(10.22~10.29)</strong></li>
                            <li>우수 설문 응답자<br />상품 수령<br /><strong>(11.05)</strong></li>
                        </ol>
                        <span>※ 10/18(월) 교재 배송과 관련한 안내 SMS를 발송합니다.</span>
                        <span>※ 10/22(금) 설문조사 안내 SMS를 발송합니다.</span>
                        <span>※ 11/5(금)에 우수 설문 응답자 발표 및 상품 발송합니다.</span>
                    </div>
                </div>
                <div className="evtCont03">
                    <div className="imgWrap"><img src="/images/events/2021/event211007/img03.png" alt="완자 VOCA PICK 소개" /></div>
                    <div className="blind">
                        <p>기출 어휘 33,051개를 분석하여 엄선한 필수 기출 어휘 수록</p>
                        <p>1회독으로 N회독 효과가 있는 단어 반복 시스템</p>
                        <p>미암기 단어만 모아 복습 가능한 휴대용 나만의 단어장</p>
                        <ul>
                            <li>[완자 VOCA PICK – 고등 필수] 학습 대상: 예비고~고1. 특장점: 10개년 학평 기출, EBS 교재, 교과서에서 엄선한 내신 1등급 필수 영단어 1600</li>
                            <li>[완자 VOCA PICK – 수능 기출] 학습 대상: 고1~고3. 특장점: 10개년 기출, EBS 교재 중 최빈출 어휘를 엄선한 수능 1등급 필수 영단어 2000</li>
                            <li>[완자 VOCA PICK – 수능 고난도] 학습 대상: 고2~고3. 특장점: 10개년 수능 고난도 문제 빈출 어휘 및 전문용어를 엄선한 수능 만점 필수 영단어 1200</li>
                        </ul>
                    </div>
                </div>
                <div className="evtCont04">
                    <div className="evtFormWrap">
                        <div className="formItem">
                            <p className="formQ"><span className="blind">완자 VOCA PICK 교재 선택하기</span></p>
                            <p>※1인 1교재 선택 가능</p>
                            <div className="formA">
                                        ...
                                        rdoData.map((item, idx) => {
                                            return (
                                                <span key={`evtRdo${idx}`} className="rdo">
                                                    ...
                                                    <label htmlFor={`formRdo0${ item.id }`}><span className="blind">{ item.labelTxt }</span></label>
                                                </span>
                                            )
                                        })
                                    }
                        ...
                        <div className="formItem">
                            <p className="formQ"><strong>&lt;완자 VOCA PICK&gt; 연구용 교재</strong>를<br />받고 싶은 이유를 작성해 주세요.</p>
                            <div className="formA">
