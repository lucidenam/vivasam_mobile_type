...
class EventApply extends Component {
    ...
    validateInfo = () => {
        ...
        if(!event.userName){
            ...
            obj.message = "국내외 역사 장소를 입력해주세요.";
        }else if(this.state.step2 === ""){
            obj.message = "역사적 사건이나 추천 이유를 입력해주세요";
        }else{
            obj.result = true;
        }
        return obj;
                ...
                <div className="vivasamter_apply">
                    <div className="vivasamter_applyDtl">
	                    ...
	                    <h2 className="info_tit mt25 txt_ls">
                            <label htmlFor="applyContent">1.한번쯤 꼭 가봐야 할 <em className="alert_em">국내외 역사 장소를</em> 추천해 주세요.</label>
	                    </h2>
                        <div className="input_wrap">
                            <input
                                type="text"
                            ...
                            <div className="count_wrap mb25">
                                <p className="count">(<span>{this.state.step1Length}</span>/20)</p>
                            </div>
                        </div>

                        <h2 className="info_tit mt25 txt_ls">
                            <label htmlFor="applyContent2">2. 장소와 관련된 <em className="alert_em">역사적 사건이나 추천 이유</em>를 적어주세요.</label>
                        </h2>
	                    <div className="input_wrap">
	                        <textarea
	                            name="applyContent2"
	                        ...
	                        <div className="count_wrap mb25">
	                            <p className="count">(<span>{this.state.step2Length}</span>/200)</p>
	                        </div>
	                    </div>
                        <button
