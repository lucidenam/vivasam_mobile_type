...
class EventApply extends Component {
    ...
    insertApplyForm = async () => {
        ...
        try {
            ...
            event.eventAnswerDesc2 = eventAnswer.eventAnswerContent.applyName+'^||^'+eventAnswer.eventAnswerContent.applyContent;
                ...
                <div className="vivasamter_apply">
                    <div className="vivasamter_applyDtl">
                        ...
                        <div className="acco_notice_list">
                            <div className="acco_notice_cont mt10">
                                ...
                                <ul class="policy">
                                    ...
                                    <li>- 개인정보 보유 및 이용기간 : 2021년 02월 28일까지 <br/>(이용목적 달성 시 즉시 파기)</li>
                        ...
                        <button
                            ...
                            className="btn_full_on2 mt20">참여하기</button>
                    </div>
                </div>
            </section>
