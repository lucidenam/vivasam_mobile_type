			...
			<section className="vivasamter">
				...
				<div className="applyDtl_top top_yell">
					<div className="applyDtl_cell ta_c pick">
						<h3><span>2024년 2학기 비바샘 꿈지기 캠페인</span><br /> 꿈 명함 만들기 프로젝트</h3>
					</div>
				</div>
						...
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList">
									<li>학급, 동아리 등 <strong>40명 이하 그룹 단위</strong>로만 신청 가능합니다.</li>
									<li>구체적인 꿈 명함 활동 계획을 알려주시면 당첨 확률이 올라갑니다.</li>
									<li>당첨되신 선생님께 꿈 명함 제작을 위한 정보를 요청 드립니다.</li>
									<li>‘꿈지기 생생후기’ 게시판에 후기 사진 게재를 위해 학생들의 <strong>초상권 활용 동의서</strong>를 수급합니다.</li>
						...
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList">
									...
									<li>개인정보 보유 및 이용기간 : 2024년 캠페인 종료까지<br/>(이용목적 달성 시 즉시 파기)   </li>
									<li>선물 발송을 위해 개인정보(성명/주소/연락처)가 배송업체에 <br/>제공됩니다. 후기 수급에 동의하지 않을 시 참여가 어렵습니다. <br/> ㈜다우기술-사업자번호: 220-81-02810, ㈜한진 –사업자등록번호 : 201-81-02823</li>
								</ul>
