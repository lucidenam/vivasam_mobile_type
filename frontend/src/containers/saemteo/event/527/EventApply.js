            ...
            <section className="vivasamter">
                ...
                <div className="applyDtl_top">
                    <div className="applyDtl_cell ta_c pick">
                        <h3><strong>꿈지기 캠페인 &lt;위인을 생각을 쓰다&gt; <br />필사 노트 </strong>신청하기</h3>
                    </div>
                </div>
                <div className="vivasamter_apply">
                    <div className="vivasamter_applyDtl pdside0">
                        <div className="pdside20 pb25">
                            ...
                            <h2 className="info_tit school_info tit_flex">
                        ...
                        <div className="acco_notice_list pdside20">
                            <div className="acco_notice_cont">
                                ...
                                <ul className="privacyList event2">
                                    <li>필사 노트는 선생님 재직 학교의 인근 비상교육 지사를 통해 전달할 예정입니다. <br/>재직 학교를 정확히 확인해 주세요.</li>
                                    <li>담당 지사에서 선생님께 직접 연락을 드릴 수 있습니다.</li>
                                    <li>지사별 배송 일정에 따라 수령 시점이 다를 수 있습니다.</li>
                                </ul>
                                <br />
                                <p className="privacyTxt">&#40;비상교육 지사 안내 : <a href="https://me.vivasam.com/#/cs/contact/hq" target="_blank">https://me.vivasam.com/#/cs/contact/hq</a> &#41;</p>
                            </div>
                        </div>
                        ...
                        <div className="acco_notice_list pdside20 notice_sec">
                            <div className="acco_notice_cont">
                                ...
                                <ul className="privacyList event2">
                                    <li>이용목적 : &lt;위인의 생각을 쓰다&gt; 필사 노트 발송, CS</li>
                                    <li>수집하는 개인정보 : 성명, 학교명, 학교 주소, 연락처</li>
                                    <li>개인정보 보유 및 이용기간 : 2024년 11월 15일까지</li>
                                </ul>
                                <br />
