...
class EventApply extends Component {
	...
	render() {
		...
		return (
			<section className="vivasamter event422">
				<h2 className="blind">
					비바샘터 신청하기
				</h2>
				<div className="applyDtl_top">
					<div className="applyDtl_cell ta_c pick">
						<h3><strong>2023 선생님 다이어리 배포 이벤트</strong></h3>
					</div>
				</div>
						...
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList">
									...
									<li>개인정보 보유 및 이용기간 : 2022년 12월 31일까지(이용목적 달성 시 즉시 파기)</li>
									<li>주소, 연락처 오기입 시 선물 재발송은 불가능합니다. <br/>개인정보를 꼭 확인해 주세요.</li>
									<li>선물 발송을 위해 서비스/배송 업체에 개인정보(성명, 학교주소, 휴대전화번호)가 제공됩니다. <br/>(㈜카카오 사업자등록번호 120-81-47521, <br/>㈜한진 사업자등록번호 : 201-81-02823, <br/>㈜CJ대한통운 사업자번호 :  110-81-05034)</li>
								</ul>
								<br />
								<p className="privacyTxt pl0">선생님께서는 개인정보의 수집 및 이용, 취급 위탁에 대한 동의를 거부할 수 있습니다. 단, 동의를 거부할 경우 신청이 불가합니다.</p>
							</div>
						</div>
