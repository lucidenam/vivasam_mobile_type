...
class EventApply extends Component {
	...
	insertApplyForm = async () => {
		...
		try {
			...
			if (response.data.code === '1') {
				...
				throw new Error("신청자가 100명이 되어 마감되었습니다.");
			} else {
	...
	render() {
		...
		return (
			<section className="vivasamter event424">
				<h2 className="blind">
					비바샘터 신청하기
				</h2>
				<div className="applyDtl_top">
					<div className="applyDtl_cell ta_c pick">
						<h3><strong>&lt;ABM 영어 교육 전문가 자격증 과정&gt; 무료 수강 EVENT</strong></h3>
					</div>
				</div>
						...
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList">
									<li>개인정보 수집 및 이용동의이용 목적 : 수강 시 개인정보 확인 및 고객문의 응대</li>
									<li>수집하는 개인정보 : 성명, 재직학교, 휴대전화번호</li>
									<li>개인정보 보유 및 이용기간 : 2023년 2월 28일까지 (이용목적 달성 시 즉시 파기)</li>
									<li>개인정보 오류 시 자격증 과정 수강이 불가하오니, <br/>개인정보를 꼭 확인해 주세요.</li>
									<li>한국영어교육학회 ABM 영어 교육 전문가 과정 무료 수강 <br/>서비스를 위해 개인정보(성명, 휴대전화번호)가 <br/>한국영어교육학회에 제공됩니다.</li>
								</ul>
								<br />
