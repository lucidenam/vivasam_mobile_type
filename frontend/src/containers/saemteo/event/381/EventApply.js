...
class EventApply extends Component {
	...
	insertApplyForm = async () => {
		...
		try {
			...
			var params = {
				...
				amountYn: 'Y',   /* 수량제한 신청 */
				applyContentTotCnt: '3',     /* 상품 종류 수 */
				applyContentNumbers: '3,4,5',    /* 상품 seq, 복수신청시는 csv(3,4,5) */
	...
	render() {
		...
		return (
			<section className="vivasamter event381">
				<h2 className="blind">
					비바샘터 신청하기
				</h2>
				<div className="applyDtl_top">
					<div className="applyDtl_cell ta_c pick">
						<h3><strong>비바샘이 준비한 연말선물 </strong></h3>
					</div>
				</div>
					...
					<div className="vivasamter_applyDtl pdside0">
						<div className="pdside20 pb25">
							...
							<div className="infoTxtWrap">
								...
								<p className="inputInfoTxt">* 잘못 기재된 주소 정보로 인해 반송된 선물은 재발송되지 않습니다.</p>
							</div>
						</div>
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList">
									<li>이용목적 : 선물 배송</li>
									<li>수집하는 개인정보 : 성명, 재직학교, 학교주소, 수령처, 휴대전화번호</li>
									<li>개인정보 보유 및 이용기간 : 2021년 12월 31일까지<br />(이용목적 달성 시 즉시 파기)</li>
									<li>수집하는 개인정보의 취급위탁 : 선물 발송을 위해 개인정보(이름/주소/연락처)를 배송업체에<br/>
										취급 위탁(CJ대한통운㈜ 사업자등록번호:110-81-05034)</li>
								</ul>
								<br />
