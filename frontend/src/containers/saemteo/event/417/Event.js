            ...
            <section className="event220919">
                <div className="evtCont01">
                    ...
                    <div className="evtPeriod">
                        <div className="blind">
                            <div><span className="tit">참여 기간</span><span className="txt">2022년 9월 19일(월) ~ 9월 26일(월)</span></div>
                            <div><span className="tit">당첨자 발표</span><span>2022년 9월 28일(수)</span></div>
                            <div>
                ...
                <div className="evtCont02">
                    <div className="event01">
                        ...
                        <div className="note">
                            <img src="/images/events/2022/event220919/evtCont1.png" alt="노트 미리보기" />
                        </div>
                        <div className="noteInfo">
                            <span>배움, 노력, 태도, 행복의 힘을 만드는 명언과 위인 소개</span>
                            <span>명언을 나만의 방식으로 표현하는 필사 페이지</span>
                        </div>
                    </div>
                    <div className="event02">
                        <h2>
                            위인의 명언을 쓰다 노트 활용 계획을 적어주세요.
                            <span>300분을 선정하여 필사노트 30권 세트를 보내드립니다.                                                                                                                                                                                          </span>
                        </h2>
                ...
                <div className="notice">
                    <ul>
                        ...
                        <li>-  정확한 주소를 기입해 주세요.<br />
                            (학교 주소, 수령처 포함 : ex. 교무실, 행정실, 학년 반, 경비실 등)
                        </li>
