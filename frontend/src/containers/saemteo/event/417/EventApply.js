...
class EventApply extends Component {
	...
	handleChange = (e) => {
		...
		if (e.target.name === 'agree' || e.target.name === 'agree1') {
	...
	validateInfo = () => {
		...
		if (!event.userName) {
			...
			obj.message = '휴대전화번호를 입력해주세요.';
		} else if (!event.agree || !event.agree1) {
			...
			<section className="vivasamter">
				...
				<div className="applyDtl_top">
					<div className="applyDtl_cell ta_c pick">
						<h3><strong>&lt;위인을 생각을 쓰다&gt; 필사 노트 신청하기</strong></h3>
					</div>
				</div>
				<div className="vivasamter_apply">
					<div className="vivasamter_applyDtl pdside0">
						<div className="pdside20 pb25">
							...
							<h2 className="info_tit school_info">
							...
							{/*{event.userInfo == 'N' && }*/}
							<p className="bulTxt mt15">* 학교 검색에서 찾으시는 학교가 없을 경우,<br />직접 입력을 통해 재직 학교명과 소재지를 입력해 주세요.</p>
						...
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								<span className="privacyTit">
									&#60;위인의 생각을 쓰다&#62; 필사 노트 배송 관련
								</span>
								<ul className="privacyList event2">
									<li>필사 노트는 선생님 재직 학교의 인근 비상교육 지사를 통해<br /> 전달할 예정입니다. 재직 학교를 정확히 확인해 주세요.</li>
									<li>담당 지사에서 선생님께 직접 연락을 드릴 수 있습니다.</li>
									<li>담당 지사는 아래 링크를 통해 확인하실 수 있습니다.</li>
								</ul>
								<br />
								<p className="privacyTxt">&#40;비상교육 지사 안내 : <a href="https://m.book.visang.com/Customer/SubCompRetrieve" target="_blank">https://m.book.visang.com/Customer/SubCompRetrieve</a> &#41;</p>
							</div>
						</div>
							...
							<div className="acco_notice_cont">
								...
								<label
									...
									<strong className="checkbox_circle_tit">
										본인은 필사 노트 배송에 대한 안내를 확인하였습니다.
									</strong>
								</label>
							</div>
						</div>
						<div className="acco_notice_list pdside20 notice_sec">
							<div className="acco_notice_cont">
								<span className="privacyTit">
									개인정보 수집 및 이용동의
								</span>
								<ul className="privacyList event2">
									<li>이용목적: &#60;위인의 생각을 쓰다&#62; 필사 노트 발송</li>
									<li>수집하는 개인정보: 성명, 학교명, 학교 주소, 연락처</li>
									<li>개인정보 보유 및 이용기간: 2022년 10월 30일까지<br />(이용목적 달성 시 즉시 파기)</li>
									<li>수집하는 개인정보의 취급위탁 : 노트 발송을 위해 개인정보(이름/주소/연락처)를 재직 학교 인근 비상교육 지사에 처리 위탁</li>
								</ul>
								<br />
