...
class Event extends Component {
    ...
    render() {
        ...
        return (
            <section className="event231016 ">
                <div className="evtCont01">
                    <img src="/images/events/2023/event231016/evtCont.png" alt="위인의 생각을 쓰다"/>
                    <div className="evtTit">
                        <div className="blind">
                            ...
                            <p className="txt">
                                ...
                                따라 쓰며 지혜로운 꿈을 꿀 수 있습니다.
                            </p>
                        </div>
                    </div>
                    <div className="evtPeriod">
                        <div className="blind">
                            <div><span className="tit">참여 기간</span><span className="txt">2023년 10월 16일(월) ~ 10월 23일(월)</span></div>
                            <div><span className="tit">당첨자 발표</span><span>2023년 10월 25일(수)</span></div>
                            <div>
                                <span>1인당 30권 세트</span>
                                <span>비상교육 지사를 통해 순차 발송</span>
                            </div>
                        </div>
                    </div>
                ...
                <div className="evtCont02">
                    <div className="event01">
                        <div className={"blind"}>
                            <h3>위인의 생각을 쓰다 노트 미리보기</h3>
                            <ul>
                                <li>배움, 노력, 태도, 행복의 힘을 만드는 명언과 위인소개</li>
                                <li>명언을 나만의 방식으로 표현하는 필사 페이지</li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div className="evtForm">
                            <div className="formBox">
                                <textarea
                                    ...
                                    maxLength={300}
                                ></textarea>
                                <span className="count">(<span className="currentCount">{evtComment.length}</span>/300)</span>
                            </div>
                ...
                <div className="notice">
                    ...
                    <ul>
                        ...
                        <li>
                            ③ 정확한 주소를 기입해주세요.<br />
                            (학교 주소, 수령처 포함: ex. 교무실, 행정실, 학년 반, 경비실 등)<br />
                            정보 기재가  잘못되어 반송된 노트를 다시 발송해드리지 않습니다.
                        </li>
                        <li>④ 참여 완료 후에는 정보 수정이 어렵습니다.</li>
