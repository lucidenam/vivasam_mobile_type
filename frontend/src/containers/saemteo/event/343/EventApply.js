...
class EventApply extends Component {
    ...
    componentDidMount = async() => {
        ...
        } else if (!eventAnswer || !eventAnswer.subjectName || !eventAnswer.applyContent) {
            // 이벤트 관련 질문에 대한 답변이 없으면 월래페이지로 이동
            history.push('/saemteo/event/view/'+eventId);
        }else{
    ...
    applyButtonClick = (target) => {
        ...
        try {
            ...
            event.eventAnswerDesc2 = eventAnswer.subjectName + '^||^' + eventAnswer.applyContent;
            SaemteoActions.pushValues({type:"event", object:event});
            // 신청 처리
            ...
            <section className="vivasamter">
                ...
                <div className="vivasamter_apply">
                    <div className="vivasamter_applyDtl">
                        ...
                        <p className="bulTxt mb25 pointColor">학교 주소 및 수령처를 정확히 기입해 주세요.</p>
                        <div className="acco_notice_list">
                            <div className="acco_notice_cont mt10">
                                ...
                                <ul className="policy">
                                    <li className="bulTxt">이용목적 : 비바샘 깨몽 마스터즈 선정 및 온라인 파티 운영</li>
                                    <li className="bulTxt">수집하는 개인정보 : 성명, 재직 학교, 학교 소재지, 수령처, 휴대전화번호</li>
                                    <li className="bulTxt">개인정보 보유 및 이용기간 : 휴대폰전화번호는 2021년 5월 31일까지만 보유하며, 재직 학교와 학교 소재지의 정보는 비바샘 개인정보에 갱신됩니다.</li>
                                    <li className="bulTxt">수집하는 개인정보의 취급위탁 : 마스터즈 선정 시 온라인 파티를 위한 경품 발송을 위해 개인정보(이름/주소/연락처)를 배송업체에 취급 위탁<br />(㈜한진 사업자등록번호 : 201-81-02823)<br />(㈜다우기술 사업자등록번호 : 220-81-02810)</li>
                                </ul>
