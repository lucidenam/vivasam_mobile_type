                    ...
                    <div className="vivasamter_applyDtl">
                        ...
                        <div className="acco_notice_list">
                            <div className="acco_notice_cont mt10">
                                <span className="acco_notice_tit info_tit pb10">과학 브로마이드 배송 관련</span>
                                <ul className="policy">
                                    <li className="bulTxt">과학 브로마이드는 선생님 재직 학교의 인근 비상교육 지사를 통해 전달할 예정입니다. 재직 학교를 정확히 확인해 주세요.</li>
                        ...
                        <div className="acco_notice_list">
                            <div className="acco_notice_cont mt10">
                                ...
                                <ul className="policy">
                                    <li className="bulTxt">이용목적 : 브로마이드 발송</li>
