...
class Event extends Component{
    ...
    render () {
        ...
        return (
            <section className="event190801">
                <h1><img src="/images/events/2019/event190801/img01.jpg" alt="2019 비바샘 꿈지기 캠페인"/></h1>
                <div className="blind">
                ...
                <h2><img src="/images/events/2019/event190801/img02.jpg" alt=""/></h2>
                <div className="blind">
                    <dl>
                        <dt>캠페인 기간</dt>
                        <dd>2019. 8. 1(목) ~ 10. 30(수) *이전에 참여하신 선생님도 응모하실 수 있습니다.</dd>
                        <dt>당첨자 선정</dt>
                        <dd>매달 2회, 사연 10개씩 선정하여 공지사항을 통해 발표합니다.</dd>
                        <dt>발표 일정</dt>
                        <dd>8/14(수), 8/30(금), 9/16(월), 9/30(월), 10/15(화), 10/31(목)</dd>
                        <dt>캠페인 선물</dt>
                ...
                <h2><img src="/images/events/2019/event190801/img03.jpg" alt="꿈 명함 제작 일정 안내"/></h2>
                <ol className="blind">
                    <li>당첨 안내</li>
                    <li>학생들의 꿈 정보 확인</li>
                    <li>꿈 명함 제작 완료</li>
                ...
                <div className="btn_apply_wrap">
                    ...
                    >
                        <img src="/images/events/2019/event190801/btn_apply.png" alt="사연 등록하기"/>
                    </button>
                </div>

                <div className="cont">
                    <img src="/images/events/2019/event190801/img_info.jpg" alt="신청 시 유의사항"/>
                    <ul className="blind">
