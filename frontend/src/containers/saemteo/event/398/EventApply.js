...
class EventApply extends Component {
	...
	applyButtonClick = (target) => {
		...
		answerNumber = answerNumber.replace("^||^", "");
		console.log("answerNumber : "+answerNumber);

		if(answerNumber === "book1") {
			this.setState({
				studentCnt : event.studentCnt + ",0"
			})
		} else if(answerNumber === "book2") {
			this.setState({
				studentCnt : "0," + event.studentCnt
			})
		}
	...
	insertApplyForm = async () => {
		...
		try {
			...
			var params = {
				...
				eventAnswerDesc2: event.eventAnswerDesc2+event.studentCnt,
			...
			<section className="vivasamter event220404">
				...
				<div className="applyDtl_top">
					<div className="applyDtl_cell ta_c pick">
						<h3><strong>2022 스터디 플래너</strong></h3>
					</div>
				</div>
						...
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList">
									...
									<li>개인정보 보유 및 이용기간 : 2022년 5월 31일까지<br/>
										(이용목적 달성 시 즉시 파기)</li>
									<li>연락처 오류 시 경품 재발송이 불가능합니다.<br/>
										개인정보를 꼭 확인해 주세요.</li>
									<li>선물 발송을 위해 배송/서비스 업체에 개인정보<br/>
