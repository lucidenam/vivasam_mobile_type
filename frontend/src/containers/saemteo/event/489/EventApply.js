...
class EventApply extends Component {
	...
	insertApplyForm = async () => {
		...
		const {nowDate, day1, day2, studentCnt} = this.state;
		...
		try {
			...
			var params = {
				...
				applyTargetContentCnt: studentCnt
	...
	render() {
		...
		return (
			<section className="vivasamter event240311">
				<h2 className="blind">
					비바샘터 신청하기
				</h2>
				<div className="applyDtl_top bg_yell">
					<div className="applyDtl_cell ta_c pick">
						<h3><strong>2024 드리밍 플래너 배포 이벤트 신청하기</strong></h3>
					</div>
				</div>
						...
						<div className="pdside20 pb25">
							...
							<div className="input_wrap mt5">
								<input
									...
									className="input_sm"/>
								<p className="evt_info_txt">※ 드리밍 플래너는 비상교육 지사를 통해 재직학교로만 배송됩니다. 정확한 학교 주소를 입력해 주세요.</p>
							</div>
						...
						<div className="acco_notice_list pdside20">
							<div className="acco_notice_cont">
								...
								<ul className="privacyList">
									...
									<li>개인정보 보유 및 이용기간 : 2024년 4월 30일까지</li>
									<li>연락처 오류 시 경품 재발송이 불가능합니다. 개인정보를 꼭 확인해 주세요.</li>
									<li>선물 발송을 위해 개인정보(성명, 연락처, 재직학교, 주소)가 지사에 공유됩니다.</li>
								</ul>
								<br />
