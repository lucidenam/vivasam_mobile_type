...
class SaemteoEventApply extends Component {
            ...
            <section className="vivasamter">
                ...
                <div className="applyDtl_top">
                    <div className="applyDtl_cell">
                        <span dangerouslySetInnerHTML={{__html: eventInfo.mobileApplyContents}}></span>
                    </div>
                </div>
                    ...
                    <div className="vivasamter_applyDtl">
                        ...
                        <div className="acco_notice_list">
                            ...
                            <div className="acco_notice_cont mt10">
                                <span dangerouslySetInnerHTML={{__html: eventInfo.mobileTerm}}></span>
                            </div>
