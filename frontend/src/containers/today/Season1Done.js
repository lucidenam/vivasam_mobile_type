...
class Season1Done extends Component {
    state = {
        data: [
        ...
        realUrl : 'https://mv.vivasam.com/#/today/Season1Done',
        devUrl : 'https://dev-mv.vivasam.com/#/today/Season1Done',
