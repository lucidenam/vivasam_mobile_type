...
class SoobakcDownloadPopupContainer extends Component {
            ...
            <section id="pop_content">
                <div className="popup_content">
                    ...
                    <div className="popup_btn_box">
                        <a onClick={doDownload} className="popup_btn_box_type3">확인</a>
                    </div>
                </div>
            </section>
        )
...
export default SoobakcDownloadPopupContainer;
