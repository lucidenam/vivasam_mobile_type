...
import { FastMusicLibrary } from 'components/livelesson';
import * as common from "../../lib/common";
import {LiveLessonDownloadContainer} from "./index";

class FastMusicLibraryContainer extends Component {
    constructor(props) {
        super(props);
        this.state = {
            tooltipActive: false,
            downloadParam: '',
            downloadUrl1 : 'https://dn.vivasam.com/vs/ebook/통합_바로바로 뽑아쓰는 중고등음악 활동+악보집_ebook.book (1)/통합_바로바로 뽑아쓰는 중고등음악 활동+악보집_ebook.book/index.html',
            tabCtrl: ['활동·악보 자료집', '영상 자료실'],
            onIdx: 0,
        }
    }
    ...
    render() {
        ...
        return <FastMusicLibrary doDownload={this.doDownload} doEbook={this.doEbook} tabCtrl={tabCtrl} onIdx={onIdx} onClickTab={this.onClickTab}></FastMusicLibrary>
    }
}
...
)(withRouter(FastMusicLibraryContainer));
