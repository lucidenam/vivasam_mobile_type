...
class Access_sso_5 extends Component {
	...
	render() {
		return (
				<div className="access_ver4">
					...
					<span className="access_desc">(1) 비바샘 교수학습지원 서비스 (초등_e.vivasam.com/, 중고등_v.vivasam.com/, 샘퀴즈_samquiz.vivasam.com/, 비바클래스_vivaclass.vivasam.com 사이트의 서비스를 말함_이하 본 약관에서 동일함)</span>
					...
					<span className="access_desc">4. 일반 회원유형으로 가입한 경우, 비바클래스 이용이 불가합니다.</span>
					...
					<span className="access_desc">이 약관은 2024년 3월 20일부터 적용합니다.</span>
				</div>
		);
	}
}

export default Access_sso_5;