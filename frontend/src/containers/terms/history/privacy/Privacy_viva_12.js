...
class Privacy_viva_12 extends Component {
							...
							<ul className="list_num">
								<li>① 권리행사방법
									<ul className="list_hyp">
										...
										<li>- 이용자의 권리 행사는 이용자의 법정대리인이나 위임을 받은 자 등 대리인을 통하여 하실 수 있습니다. 이 경우 개인정보 처리 방법에 대한 고지 별지 제11호
...
export default Privacy_viva_12;