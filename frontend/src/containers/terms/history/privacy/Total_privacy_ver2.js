...
class Total_privacy_ver2 extends Component {

	render() {
		return (
				<div className="total_privacy_ver2">
					<div className="terms_wrap privacy">
										...
										<li>
											...
											<table summary="회원가입 및 맞춤형 서비스 제공 등 필요시점에서 수집하는 정보 테이블">
												...
												<tr>
													...
													<td>추천인 아이디</td>
													<td className="textC">회원탈퇴 후 파기됩니다. 다만 관계법령에 의해 보존할 경우 그 의무기간 동안 별도 보관됩니다.</td>
												</tr>
												</tbody>
											</table>
										</li>
						...
						<div className="terms_desc">
							<ul className="list_hyp">
								<li>- 이 개인정보 처리방침은 2024. 2. 22부터 적용됩니다.</li>
...
export default Total_privacy_ver2;