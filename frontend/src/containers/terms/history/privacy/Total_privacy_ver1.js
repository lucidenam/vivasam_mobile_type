...
class Total_privacy_ver1 extends Component {

	render() {
		return (
				<div className="total_privacy_ver1">
										...
										<li>
											...
											<table summary="회원가입 및 주문 등 필요시점에서 수집하는 정보 테이블">
												...
												<tr>
													<td>본인확인(식별)</td>
													<td>&lt;휴대전화 인증 시&gt;<br/>
														[필수] 성명, 생년월일, 통신사구분, 본인인증 CI, 휴대전화번호<br/><br/>
														&lt;아이핀 인증 시&gt;<br/>
														[필수] 아이핀ID, 비밀번호
													</td>
												</tr>
										...
										<li>
											...
											<table summary="서비스 이용 과정에서 생성되는 정보 테이블">
												...
												<tr>
													<td>본인확인</td>
													<td>본인인증 CI</td>
													<td rowSpan="2">회원 탈퇴 시 또는 법정 의무 보유기간<br/>※ 쿠키의 경우, 브라우저 종료 시
							...
							<ul className="list_num">
								<li>
									...
									<ul className="list_hyp">
										...
										<li>- 이용자는 비바샘 서비스를 이용하면서 발생하는 모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
											개인정보 보호책임자 및 담당부서로 하실 수 있습니다.
										</li>
									</ul>
								</li>
								<li>
								...
								<li>① 권리행사방법
									<ul className="list_hyp">
										...
										<li>- 이용자의 권리 행사는 이용자의 법정대리인이나 위임을 받은 자 등 대리인을 통하여 하실 수 있습니다. 이 경우 개인정보
											처리 방법에 대한 고지 별지 제11호 서식에 따른 위임장을 제출하셔야 합니다.
										</li>
...
export default Total_privacy_ver1;