...
class Total_privacy_ver4 extends Component {

	render() {
		return (
				<div className="total_privacy_ver4">
					<div className="terms_wrap privacy">
							...
							<ul className="list_num">
								<li>
									...
									<ul className="list_hyp">
										...
										<li>- 비바샘은 사상·신념, 노동조합·정당의 가입·탈퇴, 정치적 견해, 건강, 성생활 등에 관한 정보, 그 밖에 이용자의 사생활을 현저히 침해할 우려가 있는 민감한 개인정보를
											수집하지 않습니다.
										</li>
									</ul>
								</li>
								...
								<li>
									...
									<ul className="list_arrow">
										<li>
											...
											<table summary="회원가입 및 맞춤형 서비스 제공 등 필요시점에서 수집하는 정보 테이블">
												...
												<tr>
													...
													<td>아이디, 비밀번호, 이름, 이메일, 휴대전화번호, 생년월일, 소속, 담당학년, 본인인증 CI, EPKI인증서 DN, EPKI인증서, 공직자 메일, 재직증명서,
														근로계약서
													</td>
												...
												<tr>
													<td rowSpan="5" className="textC">선택</td>
												...
												<tr>
													...
													<td>아이디</td>
													<td rowSpan="3" className="textC txtLine">회원탈퇴 후 즉시 파기 됩니다.</td>
												</tr>
												<tr>
													<td colSpan="2" className="textC">뚝딱학습지 서비스<br/>이용</td>
													<td>아이디, 학교, 반</td>
												</tr>
												<tr>
													<td colSpan="2" className="textC">위챌 앱 서비스<br/>이용</td>
													<td>아이디, 학교, 반</td>
												</tr>
												</tbody>
											</table>
										...
										<li>
											...
											<p>※ 비바샘은 이 외에 고객님이 이용한 서면, 문자, 게시판, 메신저 등 다양한 상담채널별 문의와 이벤트 응모시 수집 항목, 목적, 보유기간에 대한 별도 동의를 받아
												개인정보를 수집할 수 있습니다.</p>
										</li>
										<li>
											▶ 이용자 동의 후 추가로 수집하는 정보
											<p>개별 서비스 이용, 이벤트 응모 및 경품 신청 과정에서 해당 서비스 이용자에 한해 추가 개인정보 수집이 발생할 수 있습니다. 개인정보 수집 시 이용자에게 수집하는
												개인정보의 항목, 이용목적, 보관기간을 안내하고 동의를 받으며, 동의를 거부할 권리가 있다는 사실 및 동의 거부에 따른 불이익이 있는 경우에는 그 불이익의 내용을 함께
												안내합니다.</p>
						...
						<div className="terms_desc">
							<p>비바샘은 다음 목적을 위하여 개인정보를 처리합니다. 처리하고 있는 개인정보는 다음의 목적 이외의 용도로는 이용되지 않으며, 이용 목적이 변경되는 경우에는 사전에 동의를 받는 등 필요한
								조치를 이행할 예정입니다.</p>
							<table summary="수집한 개인정보 구분, 이용 목적 테이블">
								...
								<tr>
									<td>회원 관리</td>
									<td>홈페이지 가입 및 이용, 본인확인 및 가입 의사 확인, 회원제 서비스 제공에 따른 본인 식별 및 인증, 회원자격 유지 및 관리, 서비스 부정이용 방지, 회원에 대한 고지사항
										전달, 고객센터 운영, VIP 회원 서비스 제공, 고충 처리, 분쟁 조정을 위한 기록 보존 등
									</td>
								</tr>
								<tr>
									<td>맞춤 서비스 제공</td>
								...
								<tr>
									<td>마케팅 및 광고</td>
									<td>신규 서비스 및 제품 개발 안내, 이벤트 및 오프라인 행사 등 광고성 정보 전달, 인구통계학적 특성에 따른 맞춤 서비스 제공 및 홍보, 접속 빈도 파악 또는 회원의 서비스
										이용에 대한 통계
									</td>
								</tr>
								<tr>
							...
							<ul className="list_num">
								<li>
									...
									<ul className="list_hyp">
										...
										<li>- 더 나은 서비스 제공을 위하여 개인정보를 제3자에게 제공하거나 공유하게 되는 경우에는 제공받는 자, 제공하는 개인정보 항목, 제공받는 자의 개인정보 이용목적, 제공받는
										...
										<li>- 원격교육연수원은 고객님의 개인정보를 가입신청서, 이용약관, 「개인정보처리방침」의「개인정보의 수집 및 이용목적」에서 알린 범위 내에서 사용하며, 이 범위를 초과하여
						...
						<div className="terms_desc">
							<ul className="list_num">
								<li>
									① 개인정보의 파기
									<ul className="list_hyp">
										<li>- 비바샘은 이용자의 개인정보 수집/이용 목적이 달성된 경우에는 지체 없이 해당 개인정보를 파기합니다. 단, 법령에서 정보 보관 의무를 부과하는 경우와 이용자에게 보관기간에
							...
							<ul className="list_num">
								<li>① 권리행사방법
									<ul className="list_hyp">
										...
										<li>- 이용자의 권리 행사는 이용자의 법정대리인이나 위임을 받은 자 등 대리인을 통하여 하실 수 있습니다. 이 경우 개인정보 처리 방법에 대한 고지 별지 제11호 서식에 따른
											위임장을 제출하셔야 합니다.
										</li>
						...
						<div className="terms_desc">비바샘은 이용자의 개인정보를 소중히 여기며, 개인정보를 처리함에 있어서 다음과 같은 노력을 다하고 있습니다.
							<ul className="list_num">
								...
								<li>② 개인정보 취급자 최소화(구)개인정보 처리방침<p>개인정보를 처리하는 직원을 최소화 하며, 해당 직원들의 PC는 외부 인터넷망과 내부망을 분리하여 개인정보 유출 가능성을 줄이고
									있습니다. 또한 개인정보를 처리하는 데이터베이스와 개인정보처리시스템에 대한 접근 통제 기준을 체계적으로 마련하고 지속적인 감사를 시행하고 있습니다.</p></li>
								<li>③ 정기 교육<p>개인정보 취급자들을 대상으로 정기 교육을 실시하고, 전사 직원을 대상으로 개인정보 이슈 사항을 전파하여 개인정보의 중요성을 강조하고 있습니다.</p></li>
								<li>④ 해킹이나 바이러스로부터 보호<p>시스템은 외부로부터 접근이 통제된 구역에 설치하여 개인정보의 유출이나 훼손으로부터 보호합니다. 또한, 개인정보 훼손에 대비하여 정기적 백업을
									수행하고 백신프로그램을 이용하여 자료의 유출 및 손상을 방지하고 있습니다.</p></li>
								<li>⑤ 개인정보의 암호화<p>이용자의 개인정보 전송 시 암호화된 통신구간을 이용하고, 비밀번호 등 중요정보는 안전한 암호화 알고리즘을 사용하여 암호화 합니다.</p></li>
								<li>⑥ 물리적 통제<p>개인정보 처리와 관련된 시스템들은 통제구역에 위치하며, 출입을 통제합니다. 또한 개인정보가 포함된 서류, 보조저장매체는 잠금 장치가 있는 안전한 장소에
									보관합니다.</p></li>
							</ul>
						</div>
						...
						<div className="terms_desc">
							<ul className="list_hyp">
								<li>- 이 개인정보 처리방침은 2024. 4. 3부터 적용됩니다.</li>
								<li>- 개인정보 처리방침 내용에 대한 추가, 삭제 및 수정사항이 있을 경우에는 시행일 최소 7일전에 공지사항 등을 통해 안내 드리겠습니다. 이용자의 권리 또는 의무에 중요한 내용이
...
export default Total_privacy_ver4;