...
class Privacy_viva_11 extends Component {
		...
		return (
				<div className="privacy_ver11">
					<div className="terms_wrap privacy">
									...
									<ul className="list_arrow">
										<li>
											...
											<table summary="회원가입 및 주문 등 필요시점에서 수집하는 정보 테이블">
												...
												<tr>
													<td>본인확인(식별)</td>
													<td>&lt;휴대전화 인증 시&gt;<br/>[필수] 성명, 생년월일, 성별, 통신사구분, 본인인증 CI,
												...
												<tr>
													...
													<td>[필수]<br/>아이디, 비밀번호, 성명, 이메일, 휴대전화번호, 주소, 생년월일, 성별,
														재직학교명,
														담당학년, 내 교과(중고등), 비상교과서 채택여부, 본인인증 CI,
														EPKI인증서DN, EPKI인증서SN
													</td>
													<td rowSpan="3" className="textC">회원 탈퇴 시 파기<br/>(다만 관계법령에
														의해
							...
							<ul className="list_num">
								<li>
									...
									<ul className="list_hyp">
										...
										<li>
											- 비바샘은 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.
											<table summary="개인정보 제3자에게 제공 테이블">
												...
												<tr>
													...
													<td>[필수]<br/>아이디, 이름, 생년월일, 성별, 이메일, 휴대전화번호, 개인정보 유효기간, 본인
														인증
														CI
													</td>
							...
							<ul className="list_num">
								<li>① 권리행사방법
									<ul className="list_hyp">
										...
										<li>- 이용자의 권리 행사는 이용자의 법정대리인이나 위임을 받은 자 등 대리인을 통하여 하실 수 있습니다. 이 경우 개인정보
											보호법 시행규칙 별지 제11호 서식에 따른 위임장을 제출하셔야 합니다.
										</li>
										<li>- 개인정보 열람 및 처리정지 요구는 개인정보보호법 제35조 제5항, 제37조 제2항에 의하여 정보주체의 권리가 제한 될
											수 있습니다.
										</li>
						...
						<div className="terms_desc">
							<ul className="list_hyp">
								<li>- 이 개인정보 처리방침은 2021. 5. 20부터 적용됩니다.</li>
...
export default Privacy_viva_11;