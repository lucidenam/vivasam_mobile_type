...
class TermsPrivacy extends Component {
	...
	handlePopup = (e) => {
		...
		let container = <TermsPrivacyPopupHistory activeTermItem={e.target.value}/>;
	...
	render() {
		return (
			<section className="terms_content">
				<div className="termsDetails privacyDetails">
					<div className="terms_conts">
						<div className="access_txt">
							...
							<div className="terms_wrap privacy">
										...
										<li>
											...
											<ul className="list_arrow">
												<li>
													...
													<table summary="회원가입 및 맞춤형 서비스 제공 등 필요시점에서 수집하는 정보 테이블">
														...
														<tr>
															...
															<td>아이디, 비밀번호, 이름, 이메일, 휴대전화번호, 생년월일, 소속, 담당학년, 본인인증 CI, EPKI인증서 DN, EPKI인증서, 공직자 메일,
																재직증명서, 근로계약서
															</td>
															<td rowSpan="7" className="textC txtLine">
																회원 탈퇴 시 파기<br/>
														...
														<tr>
															<td rowSpan="7" className="textC">선택</td>
															<td colSpan="2" className="textC">회원가입 및 관리 <br/>(신규 가입시)</td>
															<td>추천인 아이디</td>
															<td className="textC txtLine">회원탈퇴 후 파기됩니다. 다만 관계법령에 의해 보존할 경우 그 의무기간 동안 별도 보관됩니다.</td>
														</tr>
														<tr>
															<td colSpan="2" className="textC">비바클래스 서비스 <br/>이용</td>
															<td>학교, 반, 게시물, 댓글</td>
															<td className="textC txtLine">회원탈퇴 후 30일 이후에 파기 됩니다.</td>
														</tr>
														<tr>
															<td colSpan="2" className="textC">샘퀴즈 서비스<br/>이용</td>
															<td>아이디</td>
															<td rowSpan="2" className="textC txtLine">회원탈퇴 후 즉시 파기 됩니다.</td>
														</tr>
														<tr>
														...
														<tr>
															...
															<td rowSpan="2" className="textC txtLine">회원탈퇴 후 30일 이후에 파기됩니다.</td>
														</tr>
														<tr>
												...
												<li>
													...
													<table summary="서비스 이용과정에서 생성되는 정보 테이블">
														...
														<tr>
															...
															<td>본인인증 CI</td>
															<td rowSpan="3" className="txtLine">
												...
												<li>
													...
													<ul className="list_hyp">
														<li>※ 비바샘은 이 외에 고객님이 이용한 서면, 문자, 게시판, 메신저 등 다양한 상담채널별 문의와 이벤트 응모시 수집 항목, 목적, 보유기간에 대한 별도 동의를 받아 개인정보를 수집할 수 있습니다.</li>
														<li>
															※ 비바샘은 구글(Google)에서 제공하는 Analytics를 사용하고 있습니다. Google Analytics를 통해 개인을 식별할 수 있는 정보는 수집하지 않습니다.
															<ul className="mt0 ml8">
																<li>1. Analytics 사용목적 : 서비스 이용 통계 분석</li>
																<li>2. Analytics 설치·운영 및 거부 : Google Analytics 차단 브라우저 부가 기능(add-on) 설치 : <a href="https://tools.google.com/dlpage/gaoptout" target="_blank">https://tools.google.com/dlpage/gaoptout</a></li>
																<li>3. Analytics 정보의 처리를 거부할 경우 맞춤형 서비스 이용에 어려움이 발생할 수 있습니다.</li>
															</ul>
														</li>
													</ul>
												</li>
												<li>
													...
													<table summary="이용자 동의 후 추가로 수집하는 정보 테이블">
														...
														<tr>
															...
															<td rowSpan="2" className="txtLine">이용 목적 달성 후 즉시 파기</td>
														</tr>
														<tr>
															<td>경품 및 기프티콘 발송</td>
										...
										<li>
											...
											<table summary="개인정보의 제공 및 위탁 테이블">
												...
												<tr>
													...
													<td className="txtLine">소속 교육청 및 시도 교육연수원(위탁연수 진행기관), 한국교육학술정보원(KERIS) 자체 관리</td>
												</tr>
												</tbody>
											</table>
										</li>
										<li>
											...
											<table summary="개인정보처리 위탁 정보 테이블">
												...
												<tr>
													<td>Nice 평가정보</td>
													<td>본인확인 인증</td>
													<td rowSpan="10" className="txtLine">회원 탈퇴 시 혹은 위탁계약 종료 시까지</td>
												</tr>
												<tr>
													<td>(주)북큐브네트웍스</td>
													<td>무료 전자도서관 서비스 이용</td>
								...
								<div className="terms_desc">
									<ul className="list_hyp">
										<li>- 이 개인정보 처리방침은 2025. 5. 23부터 적용됩니다.</li>
						...
						<div className="access_history">
							<h5>이전의 개인정보 처리방침은 아래에서 확인하실 수 있습니다.</h5>

							<p>[비바샘 통합회원 서비스]</p>
							<button onClick={this.handlePopup} value="total_privacy_ver6" data-name="개인정보 처리방침 2025년 3월 11일 - 2025년 5월 22일">▶ 이전 개인정보 처리방침 보기(2025년 3월 11일 - 2025년 5월 22일)</button>
							<button onClick={this.handlePopup} value="total_privacy_ver5" data-name="개인정보 처리방침 2025년 1월 2일 - 2025년 3월 10일">▶ 이전 개인정보 처리방침 보기(2025년 1월 2일 - 2025년 3월 10일)</button>
							<button onClick={this.handlePopup} value="total_privacy_ver4" data-name="개인정보 처리방침 2024년 4월 3일 - 2025년 1월 1일">▶ 이전 개인정보 처리방침 보기(2024년 4월 3일 - 2025년 1월 1일)</button>
							<button onClick={this.handlePopup} value="total_privacy_ver3" data-name="개인정보 처리방침 2024년 3월 20일 - 2024년 4월 2일">▶ 이전 개인정보 처리방침 보기(2024년 3월 20일 - 2024년 4월 2일)</button>
							<button onClick={this.handlePopup} value="total_privacy_ver2" data-name="개인정보 처리방침 2024년 2월 22일 - 2024년 3월 19일">▶ 이전 개인정보 처리방침 보기(2024년 2월 22일 - 2024년 3월 19일)</button>
							<button onClick={this.handlePopup} value="total_privacy_ver1" data-name="개인정보 처리방침 2023년 9월 24일 - 2024년 2월 21일">▶ 이전 개인정보 처리방침 보기(2023년 9월 24일 - 2024년 2월 21일)</button>

							<p>[비바샘 교수학습지원 서비스]</p>
							<button onClick={this.handlePopup} value="privacy_ver1_14" data-name="개인정보 처리방침 2022년 5월 10일 – 2023년 9월 23일">▶ 이전 개인정보 처리방침 보기(2022년 5월 10일 – 2023년 9월 23일)</button>
							<button onClick={this.handlePopup} value="privacy_ver1_13" data-name="개인정보 처리방침 2022년 7월 11일 – 2023년 5월 9일">▶ 이전 개인정보 처리방침 보기(2022년 7월 11일 – 2023년 5월 9일)</button>
							<button onClick={this.handlePopup} value="privacy_ver1_12" data-name="개인정보 처리방침 2022년 4월 14일 – 2022년 7월 10일">▶ 이전 개인정보 처리방침 보기(2022년 4월 14일 – 2022년 7월 10일)</button>
							<button onClick={this.handlePopup} value="privacy_ver1_11" data-name="개인정보 처리방침 2021년 5월 20일 – 2022년 4월 13일">▶ 이전 개인정보 처리방침 보기(2021년 5월 20일 – 2022년 4월 13일)</button>
							<button onClick={this.handlePopup} value="privacy_ver1_10" data-name="개인정보 처리방침 2019년 12월 30일 – 2021년 5월 19일">▶ 이전 개인정보 처리방침 보기(2019년 12월 30일 – 2021년 5월 19일)</button>
							<button onClick={this.handlePopup} value="privacy_ver1_9" data-name="개인정보 처리방침 2019년 8월 31일 – 2019년 12월 29일">▶ 이전 개인정보 처리방침 보기(2019년 8월 31일 – 2019년 12월 29일)</button>
							<button onClick={this.handlePopup} value="privacy_ver1_8" data-name="개인정보 처리방침 2018년 11월 9일 – 2019년 8월 30일">▶ 이전 개인정보 처리방침 보기(2018년 11월 9일 – 2019년 8월 30일)</button>
							<button onClick={this.handlePopup} value="privacy_ver1_7" data-name="개인정보 처리방침 2018년 2월 26일 – 2018년 11월 8일">▶ 이전 개인정보 처리방침 보기(2018년 2월 26일 – 2018년 11월 8일)</button>
							<button onClick={this.handlePopup} value="privacy_ver1_6" data-name="개인정보 처리방침 2017년 12월 26일 – 2018년 2월 25일">▶ 이전 개인정보 처리방침 보기(2017년 12월 26일 – 2018년 2월 25일)</button>
							<button onClick={this.handlePopup} value="privacy_ver1_5" data-name="개인정보 처리방침 2016년 12월 9일 – 2017년 12월 25일">▶ 이전 개인정보 처리방침 보기(2016년 12월 9일 – 2017년 12월 25일)</button>
							<button onClick={this.handlePopup} value="privacy_ver1_4" data-name="개인정보 취급방침 2015년 12월 1일 – 2016년 12월 8일">▶ 이전 개인정보 취급방침 보기(2015년 12월 1일 – 2016년 12월 8일)</button>
							<button onClick={this.handlePopup} value="privacy_ver1_3" data-name="개인정보 취급방침 2015년 7월 31일 – 2015년 11월 30일">▶ 이전 개인정보 취급방침 보기(2015년 7월 31일 – 2015년 11월 30일)</button>
							<button onClick={this.handlePopup} value="privacy_ver1_2" data-name="개인정보 취급방침 2014년 2월 27일 – 2015년 7월 30일">▶ 이전 개인정보 취급방침 보기(2014년 2월 27일 – 2015년 7월 30일)</button>
							<button onClick={this.handlePopup} value="privacy_ver1_1" data-name="개인정보 취급방침 2013년 2월 18일 - 2014년 2월 26일">▶ 이전 개인정보 취급방침 보기(2013년 2월 18일 - 2014년 2월 26일)</button>

							<p>[비바샘 원격교육연수원 서비스]</p>
							<button onClick={this.handlePopup} value="privacy_ver2_16" data-name="개인정보 처리방침 2023년 1월 2일 ~ 2023년 9월 23일">▶ 이전 개인정보처리방침 보기 (2023년 1월 2일 ~ 2023년 9월 23일)</button>
							<button onClick={this.handlePopup} value="privacy_ver2_15" data-name="개인정보 처리방침 2022년 4월 29일 ~ 2023년 1월 1일">▶ 이전 개인정보처리방침 보기 (2022년 4월 29일 ~ 2023년 1월 1일)</button>
							<button onClick={this.handlePopup} value="privacy_ver2_14" data-name="개인정보 처리방침 2022년 3월 11일 ~ 2022년 4월 28일">▶ 이전 개인정보처리방침 보기 (2022년 3월 11일 ~ 2022년 4월 28일)</button>
							<button onClick={this.handlePopup} value="privacy_ver2_13" data-name="개인정보 처리방침 2020년 12월 14일 ~ 2022년 3월 10일">▶ 이전 개인정보처리방침 보기 (2020년 12월 14일 ~ 2022년 3월 10일)</button>
							<button onClick={this.handlePopup} value="privacy_ver2_12" data-name="개인정보 처리방침 2020년 11월 9일 ~ 2020년 12월 13일">▶ 이전 개인정보처리방침 보기 (2020년 11월 9일 ~ 2020년 12월 13일)</button>
							<button onClick={this.handlePopup} value="privacy_ver2_11" data-name="개인정보 처리방침 2020년 7월 5일 ~ 2020년 11월 8일">▶ 이전 개인정보처리방침 보기 (2020년 7월 5일 ~ 2020년 11월 8일)</button>
							<button onClick={this.handlePopup} value="privacy_ver2_10" data-name="개인정보 처리방침 2020년 1월 13일 ~ 2020년 7월 4일">▶ 이전 개인정보처리방침 보기 (2020년 1월 13일 ~ 2020년 7월 4일)</button>
							<button onClick={this.handlePopup} value="privacy_ver2_9" data-name="개인정보 처리방침 2019년 8월 31일 ~ 2020년 1월 12일">▶ 이전 개인정보처리방침 보기 (2019년 8월 31일 ~ 2020년 1월 12일)</button>
							<button onClick={this.handlePopup} value="privacy_ver2_8" data-name="개인정보 처리방침 2018년 10월 15일 ~ 2019년 8월 30일">▶ 이전 개인정보처리방침 보기 (2018년 10월 15일 ~ 2019년 8월 30일)</button>
							<button onClick={this.handlePopup} value="privacy_ver2_7" data-name="개인정보 처리방침 2018년 4월 23일 - 2018년 10월 14일">▶ 이전 개인정보처리방침 보기 (2018년 4월 23일 - 2018년 10월 14일)</button>
							<button onClick={this.handlePopup} value="privacy_ver2_6" data-name="개인정보 처리방침 2018년 2월 26일 - 2018년 4월 22일">▶ 이전 개인정보처리방침 보기 (2018년 2월 26일 - 2018년 4월 22일)</button>
							<button onClick={this.handlePopup} value="privacy_ver2_5" data-name="개인정보 처리방침 2016년 11월 1일 - 2018년 2월 25일">▶ 이전 개인정보처리방침 보기 (2016년 11월 1일 - 2018년 2월 25일)</button>
							<button onClick={this.handlePopup} value="privacy_ver2_4" data-name="개인정보 처리방침 2016년 8월 1일 - 2016년 10월 31일">▶ 이전 개인정보처리방침 보기 (2016년 8월 1일 - 2016년 10월 31일)</button>
							<button onClick={this.handlePopup} value="privacy_ver2_3" data-name="개인정보 처리방침 2016년 5월 20일 - 2016년 7월 31일">▶ 이전 개인정보처리방침 보기 (2016년 5월 20일 - 2016년 7월 31일)</button>
							<button onClick={this.handlePopup} value="privacy_ver2_2" data-name="개인정보 처리방침 2015년 8월 23일 - 2016년 5월 19일">▶ 이전 개인정보처리방침 보기 (2015년 8월 23일 - 2016년 5월 19일)</button>
							<button onClick={this.handlePopup} value="privacy_ver2_1" data-name="개인정보 처리방침 2013년 11월 15일 - 2015년 8월 22일">▶ 이전 개인정보처리방침 보기 (2013년 11월 15일 - 2015년 8월 22일)</button>
